...
portfolio.ui.client.render = (function portfolio$ui$client$render(app,p__32582){
var map__32583 = p__32582;
var map__32583__$1 = cljs.core.__destructure_map(map__32583);
var on_render = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32583__$1,new cljs.core.Keyword(null,"on-render","on-render",2096729391));
...
var G__32731 = el__$1.parentNode;
el__$1 = G__32731;
continue;
...
var path = (function (){var G__32587 = e.target;
var G__32587__$1 = (((G__32587 == null))?null:portfolio.ui.client.a_element(G__32587));
var G__32587__$2 = (((G__32587__$1 == null))?null:G__32587__$1.href);
if((G__32587__$2 == null)){
return null;
} else {
return portfolio.ui.client.get_path(G__32587__$2);
}
})();
...
var el_32737 = document.createElement("div");
(el_32737.id = "portfolio");

document.body.appendChild(el_32737);
...
var len__5769__auto___32740 = arguments.length;
var i__5770__auto___32745 = (0);
while(true){
if((i__5770__auto___32745 < len__5769__auto___32740)){
args__5775__auto__.push((arguments[i__5770__auto___32745]));

var G__32750 = (i__5770__auto___32745 + (1));
i__5770__auto___32745 = G__32750;
continue;
} else {
}
break;
...
(portfolio.ui.client.start_app.cljs$core$IFn$_invoke$arity$variadic = (function (app,p__32664){
var vec__32669 = p__32664;
var map__32672 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32669,(0),null);
var map__32672__$1 = cljs.core.__destructure_map(map__32672);
var on_render = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32672__$1,new cljs.core.Keyword(null,"on-render","on-render",2096729391));
...
document.body.addEventListener("click",(function (p1__32606_SHARP_){
return portfolio.ui.client.relay_body_clicks(app,p1__32606_SHARP_);
}));
...
cljs.core.add_tap((function (p1__32607_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$variadic(app,cljs.core.update,new cljs.core.Keyword(null,"taps","taps",480110748),cljs.core.conj,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([p1__32607_SHARP_], 0));
}));
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"go-to-location","go-to-location",-1047138405),(function (){var G__32719 = location__$1;
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__32719,new cljs.core.Keyword(null,"query-params","query-params",900640534),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"doc","doc",1913296891),"up-and-running"], null));
} else {
return G__32719;
}
})()], null);
...
/** @this {Function} */
(portfolio.ui.client.start_app.cljs$lang$applyTo = (function (seq32610){
var G__32611 = cljs.core.first(seq32610);
var seq32610__$1 = cljs.core.next(seq32610);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32611,seq32610__$1);
}));
