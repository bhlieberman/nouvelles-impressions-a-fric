...
var G__31997 = state;
var G__31998 = view;
var G__31999 = (function (){var G__32000 = ctx;
if(cljs.core.not(portfolio.ui.canvas.code.show_code_QMARK_(state,tool,ctx))){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__32000,new cljs.core.Keyword(null,"scenes","scenes",-425219404),(function (scenes){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31967_SHARP_){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(p1__31967_SHARP_,new cljs.core.Keyword(null,"code","code",1586293142));
}),scenes);
}));
} else {
return G__32000;
...
return (f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__31997,G__31998,G__31999) : f.call(null,G__31997,G__31998,G__31999));
...
var G__32001 = (f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(state,location,view) : f.call(null,state,location,view));
...
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__32001,new cljs.core.Keyword(null,"code","code",1586293142));
} else {
return G__32001;
}
})], null));
