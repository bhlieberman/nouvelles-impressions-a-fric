...
var rewrite_clj$node$protocols$Node$tag$dyn_26407 = (function (node){
...
return rewrite_clj$node$protocols$Node$tag$dyn_26407(node);
}
});

var rewrite_clj$node$protocols$Node$node_type$dyn_26411 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$node_type$dyn_26411(node);
}
});

var rewrite_clj$node$protocols$Node$printable_only_QMARK_$dyn_26412 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$printable_only_QMARK_$dyn_26412(node);
}
});

var rewrite_clj$node$protocols$Node$sexpr_STAR_$dyn_26417 = (function (node,opts){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$sexpr_STAR_$dyn_26417(node,opts);
}
});

var rewrite_clj$node$protocols$Node$length$dyn_26418 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$length$dyn_26418(node);
}
});

var rewrite_clj$node$protocols$Node$string$dyn_26419 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$string$dyn_26419(node);
}
});
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__26280_SHARP_){
return rewrite_clj.node.protocols.sexpr.cljs$core$IFn$_invoke$arity$2(p1__26280_SHARP_,opts);
...
var rewrite_clj$node$protocols$InnerNode$inner_QMARK_$dyn_26448 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$inner_QMARK_$dyn_26448(node);
}
});

var rewrite_clj$node$protocols$InnerNode$children$dyn_26449 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$children$dyn_26449(node);
}
});

var rewrite_clj$node$protocols$InnerNode$replace_children$dyn_26450 = (function (node,children){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$replace_children$dyn_26450(node,children);
}
});

var rewrite_clj$node$protocols$InnerNode$leader_length$dyn_26453 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$leader_length$dyn_26453(node);
}
});
...
var rewrite_clj$node$protocols$NodeCoerceable$coerce$dyn_26458 = (function (form){
...
return rewrite_clj$node$protocols$NodeCoerceable$coerce$dyn_26458(form);
}
});
...
var rewrite_clj$node$protocols$MapQualifiable$map_context_apply$dyn_26464 = (function (node,map_qualifier){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$MapQualifiable$map_context_apply$dyn_26464(node,map_qualifier);
}
});

var rewrite_clj$node$protocols$MapQualifiable$map_context_clear$dyn_26470 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$MapQualifiable$map_context_clear$dyn_26470(node);
}
});
...
var map__26371 = cljs.core.meta(node);
var map__26371__$1 = cljs.core.__destructure_map(map__26371);
var row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26371__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26371__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var next_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26371__$1,new cljs.core.Keyword(null,"next-row","next-row",-408963777));
var next_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26371__$1,new cljs.core.Keyword(null,"next-col","next-col",601697889));
...
rewrite_clj.node.protocols._PLUS_extent = (function rewrite_clj$node$protocols$_PLUS_extent(p__26378,p__26379){
var vec__26381 = p__26378;
var row = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26381,(0),null);
var col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26381,(1),null);
var vec__26384 = p__26379;
var row_extent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26384,(0),null);
var col_extent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26384,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(row + row_extent),(function (){var G__26391 = col_extent;
if((row_extent === (0))){
return (G__26391 + col);
} else {
return G__26391;
...
if(cljs.core.truth_(rewrite_clj.node.protocols.inner_QMARK_(node))){
var G__26397 = rewrite_clj.node.protocols.children(node);
var G__26397__$1 = (((G__26397 == null))?null:cljs.core.first(G__26397));
if((G__26397__$1 == null)){
return null;
} else {
return cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.tag,rewrite_clj.node.protocols.sexpr)(G__26397__$1);
}
} else {
