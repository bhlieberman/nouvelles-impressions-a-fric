...
return [(function (){var pred__14752 = cljs.core.instance_QMARK_;
var expr__14753 = reactive_val;
if(cljs.core.truth_((pred__14752.cljs$core$IFn$_invoke$arity$2 ? pred__14752.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.RAtom,expr__14753) : pred__14752.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.RAtom,expr__14753)))){
return "ra";
} else {
if(cljs.core.truth_((pred__14752.cljs$core$IFn$_invoke$arity$2 ? pred__14752.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.RCursor,expr__14753) : pred__14752.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.RCursor,expr__14753)))){
return "rc";
} else {
if(cljs.core.truth_((pred__14752.cljs$core$IFn$_invoke$arity$2 ? pred__14752.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.Reaction,expr__14753) : pred__14752.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.Reaction,expr__14753)))){
return "rx";
} else {
if(cljs.core.truth_((pred__14752.cljs$core$IFn$_invoke$arity$2 ? pred__14752.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.Track,expr__14753) : pred__14752.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.Track,expr__14753)))){
return "tr";
} else {
return "other";
}
