...
var len__5769__auto___38360 = arguments.length;
var i__5770__auto___38361 = (0);
while(true){
if((i__5770__auto___38361 < len__5769__auto___38360)){
args__5775__auto__.push((arguments[i__5770__auto___38361]));

var G__38362 = (i__5770__auto___38361 + (1));
i__5770__auto___38361 = G__38362;
continue;
} else {
}
break;
...
/** @this {Function} */
(sci.impl.opts.process_permissions.cljs$lang$applyTo = (function (seq38246){
var G__38247 = cljs.core.first(seq38246);
var seq38246__$1 = cljs.core.next(seq38246);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38247,seq38246__$1);
}));
...
var G__38365 = null;
var G__38365__1 = (function (msg){
return (new Error(msg));
});
var G__38365__2 = (function (msg,filename){
return (new Error(msg,filename));
});
var G__38365__3 = (function (msg,filename,line){
return (new Error(msg,filename,line));
});
G__38365 = function(msg,filename,line){
switch(arguments.length){
case 1:
return G__38365__1.call(this,msg);
case 2:
return G__38365__2.call(this,msg,filename);
case 3:
return G__38365__3.call(this,msg,filename,line);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__38365.cljs$core$IFn$_invoke$arity$1 = G__38365__1;
G__38365.cljs$core$IFn$_invoke$arity$2 = G__38365__2;
G__38365.cljs$core$IFn$_invoke$arity$3 = G__38365__3;
return G__38365;
})()
], null),new cljs.core.Symbol(null,"cljs.core.PersistentQueue.EMPTY","cljs.core.PersistentQueue.EMPTY",399917828,null),cljs.core.PersistentQueue.EMPTY,new cljs.core.Symbol(null,"goog.string.StringBuffer","goog.string.StringBuffer",-1220229842,null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),goog.string.StringBuffer,new cljs.core.Keyword(null,"constructor","constructor",-1953928811),(function (p1__38263_SHARP_){
return (new goog.string.StringBuffer(p1__38263_SHARP_));
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__38285 = temp__5802__auto__;
var sym = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38285,(0),null);
var class_opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38285,(1),null);
var G__38374 = cljs.core.assoc_BANG_.cljs$core$IFn$_invoke$arity$3(class__GT_opts,sym,((cljs.core.map_QMARK_(class_opts))?class_opts:new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),class_opts], null)));
var G__38375 = cljs.core.rest(kvs);
class__GT_opts = G__38374;
kvs = G__38375;
continue;
} else {
 ...
 * Initializes options
 */
sci.impl.opts.init = (function sci$impl$opts$init(p__38310){
var map__38311 = p__38310;
var map__38311__$1 = cljs.core.__destructure_map(map__38311);
var features = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38311__$1,new cljs.core.Keyword(null,"features","features",-1146962336));
var namespaces = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38311__$1,new cljs.core.Keyword(null,"namespaces","namespaces",-1444157469));
var ns_aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38311__$1,new cljs.core.Keyword(null,"ns-aliases","ns-aliases",1290254821));
var js_libs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38311__$1,new cljs.core.Keyword(null,"js-libs","js-libs",-502933721));
var bindings = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38311__$1,new cljs.core.Keyword(null,"bindings","bindings",1271397192));
var readers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38311__$1,new cljs.core.Keyword(null,"readers","readers",-2118263030));
var reify_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38311__$1,new cljs.core.Keyword(null,"reify-fn","reify-fn",-1360983316));
var env = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38311__$1,new cljs.core.Keyword(null,"env","env",-1815813235));
var imports = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38311__$1,new cljs.core.Keyword(null,"imports","imports",-1249933394));
var allow = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38311__$1,new cljs.core.Keyword(null,"allow","allow",-1857325745));
var load_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38311__$1,new cljs.core.Keyword(null,"load-fn","load-fn",-2121144334));
var async_load_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38311__$1,new cljs.core.Keyword(null,"async-load-fn","async-load-fn",-472170029));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38311__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
var deny = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38311__$1,new cljs.core.Keyword(null,"deny","deny",1589338523));
var proxy_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38311__$1,new cljs.core.Keyword(null,"proxy-fn","proxy-fn",1116677438));
var classes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38311__$1,new cljs.core.Keyword(null,"classes","classes",2037804510));
...
var features = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38318__$1,new cljs.core.Keyword(null,"features","features",-1146962336));
var namespaces = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38318__$1,new cljs.core.Keyword(null,"namespaces","namespaces",-1444157469));
var ns_aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38318__$1,new cljs.core.Keyword(null,"ns-aliases","ns-aliases",1290254821));
var js_libs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38318__$1,new cljs.core.Keyword(null,"js-libs","js-libs",-502933721));
var bindings = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38318__$1,new cljs.core.Keyword(null,"bindings","bindings",1271397192));
var readers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38318__$1,new cljs.core.Keyword(null,"readers","readers",-2118263030));
var reify_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38318__$1,new cljs.core.Keyword(null,"reify-fn","reify-fn",-1360983316));
var imports = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38318__$1,new cljs.core.Keyword(null,"imports","imports",-1249933394));
var allow = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38318__$1,new cljs.core.Keyword(null,"allow","allow",-1857325745));
var load_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__38318__$1,new cljs.core.Keyword(null,"load-fn","load-fn",-2121144334),new cljs.core.Keyword(null,"load-fn","load-fn",-2121144334).cljs$core$IFn$_invoke$arity$1(env));
var async_load_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__38318__$1,new cljs.core.Keyword(null,"async-load-fn","async-load-fn",-472170029),new cljs.core.Keyword(null,"async-load-fn","async-load-fn",-472170029).cljs$core$IFn$_invoke$arity$1(env));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38318__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
var deny = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38318__$1,new cljs.core.Keyword(null,"deny","deny",1589338523));
var classes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38318__$1,new cljs.core.Keyword(null,"classes","classes",2037804510));
