...
var periods__$1 = cljs.core.vec((function (){var G__52150 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52147_SHARP_){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__52147_SHARP_,(0),(3));
}),G__52150);
} else {
return G__52150;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__52183){
var vec__52184 = p__52183;
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52184,(0),null);
var pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52184,(1),null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__52189 = pattern;
switch (G__52189) {
case "S":
...
return p1__52190_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__52191_SHARP_){
return p1__52191_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__52192_SHARP_){
return p1__52192_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__52193_SHARP_){
return p1__52193_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__52194_SHARP_){
return p1__52194_SHARP_.getHours();
});

break;
case "day":
return (function (p1__52195_SHARP_){
return p1__52195_SHARP_.getDate();
});

break;
case "month":
return (function (p1__52196_SHARP_){
return p1__52196_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__52197_SHARP_){
return p1__52197_SHARP_.getYear();
});

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__52198__$1)].join('')));

}
});
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__52200){
...
var key = first__52203;
var args = seq__52202__$1;
var G__52205 = key;
...
break;
case "ordinal-suffix":
var vec__52207 = (function (){var G__52210 = (i - (1));
return (syntax_list.cljs$core$IFn$_invoke$arity$1 ? syntax_list.cljs$core$IFn$_invoke$arity$1(G__52210) : syntax_list.call(null,G__52210));
})();
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52207,(0),null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__52205__$1)].join('')));
...
var d = value;
var G__52216 = cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__52217 = G__52216;
...
var unparser = first__52219;
var more = seq__52218__$1;
var s = "";
var d__$1 = d;
var G__52216__$1 = G__52216;
var s__$1 = s;
while(true){
var d__$2 = d__$1;
var vec__52227 = G__52216__$1;
...
var unparser__$1 = first__52229;
var more__$1 = seq__52228__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__52230 = (unparser__$1.cljs$core$IFn$_invoke$arity$2 ? unparser__$1.cljs$core$IFn$_invoke$arity$2(s__$2,d__$2) : unparser__$1.call(null,s__$2,d__$2));
var s__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52230,(0),null);
var d__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52230,(1),null);
var G__52286 = d__$3;
var G__52287 = more__$1;
var G__52288 = s__$3;
d__$1 = G__52286;
G__52216__$1 = G__52287;
s__$1 = G__52288;
continue;
}
break;
