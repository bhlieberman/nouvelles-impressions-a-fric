...
var len__5769__auto___27463 = arguments.length;
var i__5770__auto___27464 = (0);
while(true){
if((i__5770__auto___27464 < len__5769__auto___27463)){
args__5775__auto__.push((arguments[i__5770__auto___27464]));

var G__27465 = (i__5770__auto___27464 + (1));
i__5770__auto___27464 = G__27465;
continue;
} else {
}
break;
...
(rewrite_clj.parser.token.read_to_boundary.cljs$core$IFn$_invoke$arity$variadic = (function (reader,p__27443){
var vec__27444 = p__27443;
var allowed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27444,(0),null);
var allowed_QMARK_ = cljs.core.set(allowed);
return rewrite_clj.reader.read_until(reader,(function (p1__27439_SHARP_){
var and__5043__auto__ = cljs.core.not((allowed_QMARK_.cljs$core$IFn$_invoke$arity$1 ? allowed_QMARK_.cljs$core$IFn$_invoke$arity$1(p1__27439_SHARP_) : allowed_QMARK_.call(null,p1__27439_SHARP_)));
if(and__5043__auto__){
return rewrite_clj.reader.whitespace_or_boundary_QMARK_(p1__27439_SHARP_);
} else {
...
/** @this {Function} */
(rewrite_clj.parser.token.read_to_boundary.cljs$lang$applyTo = (function (seq27441){
var G__27442 = cljs.core.first(seq27441);
var seq27441__$1 = cljs.core.next(seq27441);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27442,seq27441__$1);
}));
