...
var i_43049 = (0);
while(true){
if((i_43049 < arr.length)){
(arr[i_43049] = null);

var G__43050 = (i_43049 + (1));
i_43049 = G__43050;
continue;
} else {
}
...
var i_43063 = (self__.level + (1));
while(true){
if((i_43063 <= (new_level + (1)))){
(update[i_43063] = self__.header);

var G__43065 = (i_43063 + (1));
i_43063 = G__43065;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_43066 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_43066[i]));
} else {
x__$2.forward.push((((i < links_43066.length))?(links_43066[i]):null));
}

if((i < links_43066.length)){
(links_43066[i] = x__$2);
} else {
links_43066.push(x__$2);
}
...
var i_43068 = (0);
while(true){
if((i_43068 <= self__.level)){
var links_43069 = (update[i_43068]).forward;
if((x__$1 === (((i_43068 < links_43069.length))?(links_43069[i_43068]):null))){
(links_43069[i_43068] = (x__$1.forward[i_43068]));

var G__43072 = (i_43068 + (1));
i_43068 = G__43072;
continue;
} else {
var G__43073 = (i_43068 + (1));
i_43068 = G__43073;
continue;
}
} else {
...
var G__43075 = nx;
var G__43076 = (level__$1 - (1));
x = G__43075;
level__$1 = G__43076;
continue;
} else {
var G__43077 = x;
var G__43078 = (level__$1 - (1));
x = G__43077;
level__$1 = G__43078;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__43081 = nx;
var G__43082 = (level__$1 - (1));
x = G__43081;
level__$1 = G__43082;
continue;
} else {
var G__43083 = x;
var G__43084 = (level__$1 - (1));
x = G__43083;
level__$1 = G__43084;
continue;
}
