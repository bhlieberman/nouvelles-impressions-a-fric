...
import "./rewrite_clj.node.fn.js";
import "./rewrite_clj.node.meta.js";
import "./rewrite_clj.node.protocols.js";
import "./rewrite_clj.node.quote.js";
import "./rewrite_clj.node.reader_macro.js";
import "./rewrite_clj.node.regex.js";
import "./rewrite_clj.node.seq.js";
import "./rewrite_clj.node.token.js";
import "./rewrite_clj.node.uneval.js";
import "./rewrite_clj.parser.keyword.js";
import "./rewrite_clj.parser.namespaced_map.js";
import "./rewrite_clj.parser.string.js";
import "./rewrite_clj.parser.token.js";
import "./rewrite_clj.parser.whitespace.js";
...
var hierarchy__5646__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__27645 = cljs.core.get_global_hierarchy;
return (fexpr__27645.cljs$core$IFn$_invoke$arity$0 ? fexpr__27645.cljs$core$IFn$_invoke$arity$0() : fexpr__27645.call(null));
})());
...
return rewrite_clj.reader.read_repeatedly(reader,(function (p1__27647_SHARP_){
var _STAR_delimiter_STAR__orig_val__27650 = rewrite_clj.parser.core._STAR_delimiter_STAR_;
var _STAR_delimiter_STAR__temp_val__27651 = delimiter;
(rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__temp_val__27651);

try{return rewrite_clj.parser.core.parse_next(p1__27647_SHARP_);
}finally {(rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__orig_val__27650);
}}));
});
rewrite_clj.parser.core.parse_printables = (function rewrite_clj$parser$core$parse_printables(var_args){
var args__5775__auto__ = [];
var len__5769__auto___27683 = arguments.length;
var i__5770__auto___27685 = (0);
while(true){
if((i__5770__auto___27685 < len__5769__auto___27683)){
args__5775__auto__.push((arguments[i__5770__auto___27685]));

var G__27686 = (i__5770__auto___27685 + (1));
i__5770__auto___27685 = G__27686;
continue;
} else {
}
break;
...
(rewrite_clj.parser.core.parse_printables.cljs$core$IFn$_invoke$arity$variadic = (function (reader,node_tag,n,p__27657){
var vec__27658 = p__27657;
var ignore_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27658,(0),null);
...
/** @this {Function} */
(rewrite_clj.parser.core.parse_printables.cljs$lang$applyTo = (function (seq27652){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27653,G__27654,G__27655,seq27652__$3);
}));
...
var G__27671 = rewrite_clj.reader.peek(reader);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__27671)){
return rewrite_clj.reader.throw_reader(reader,"Unexpected EOF.");
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("!",G__27671)){
...
return cljs.core.cons((function (){var G__27676 = rewrite_clj.reader.peek(reader);
switch (G__27676) {
case "(":
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("_",G__27671)){
