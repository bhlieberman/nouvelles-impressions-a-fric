...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(cljs.core.keyword,(function (p1__51723_SHARP_){
return reitit.frontend.query_param(q,p1__51723_SHARP_);
})),q.getKeys()));
});
/**
...
var new_query = ((cljs.core.fn_QMARK_(new_query_or_update_fn))?(function (){var G__51728 = reitit.frontend.query_params(uri);
return (new_query_or_update_fn.cljs$core$IFn$_invoke$arity$1 ? new_query_or_update_fn.cljs$core$IFn$_invoke$arity$1(G__51728) : new_query_or_update_fn.call(null,G__51728));
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__51733),"#",reitit.impl.form_encode(fragment)].join('');
} else {
return G__51733;
}
} else {
...
(reitit.frontend.match_by_path.cljs$core$IFn$_invoke$arity$3 = (function (router,path,p__51750){
var map__51751 = p__51750;
var map__51751__$1 = cljs.core.__destructure_map(map__51751);
var on_coercion_error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51751__$1,new cljs.core.Keyword(null,"on-coercion-error","on-coercion-error",-970787));
var uri = goog.Uri.parse(path);
var coerce_BANG_ = (cljs.core.truth_(on_coercion_error)?(function (match){
try{return reitit.coercion.coerce_BANG_(match);
}catch (e51755){if((e51755 instanceof Error)){
var e = e51755;
...
if(cljs.core.every_QMARK_((function (p1__51785_SHARP_){
return cljs.core.contains_QMARK_(path_params,p1__51785_SHARP_);
