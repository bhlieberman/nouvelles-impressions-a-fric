...
return cljs.core.keep_indexed.cljs$core$IFn$_invoke$arity$2((function (p1__16802_SHARP_,p2__16801_SHARP_){
if(cljs.core.truth_((pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(p2__16801_SHARP_) : pred.call(null,p2__16801_SHARP_)))){
return p1__16802_SHARP_;
} else {
return null;
}
}),v);
...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__16807_SHARP_){
return (((beginning <= new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__16807_SHARP_))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__16807_SHARP_) <= ending)));
}));
});
/**
 ...
 */
day8.re_frame_10x.tools.coll.dissoc_in = (function day8$re_frame_10x$tools$coll$dissoc_in(m,p__16818){
var vec__16821 = p__16818;
var seq__16822 = cljs.core.seq(vec__16821);
var first__16823 = cljs.core.first(seq__16822);
var seq__16822__$1 = cljs.core.next(seq__16822);
var k = first__16823;
var ks = seq__16822__$1;
if(ks){
...
var children = (function (p1__16851_SHARP_){
if(cljs.core.coll_QMARK_(p1__16851_SHARP_)){
return cljs.core.seq(p1__16851_SHARP_);
} else {
return null;
}
});
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__16873_SHARP_){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__16873_SHARP_,cljs.core.contains_QMARK_(ks__$1,p1__16873_SHARP_)], null);
})),possible_ks);
});
