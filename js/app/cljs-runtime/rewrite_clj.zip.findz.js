...
import "./rewrite_clj.zip.base.js";
import "./rewrite_clj.zip.move.js";
...
var len__5769__auto___29516 = arguments.length;
var i__5770__auto___29517 = (0);
while(true){
if((i__5770__auto___29517 < len__5769__auto___29516)){
args__5775__auto__.push((arguments[i__5770__auto___29517]));

var G__29518 = (i__5770__auto___29517 + (1));
i__5770__auto___29517 = G__29518;
continue;
} else {
}
break;
...
(rewrite_clj.zip.findz.tag_predicate.cljs$core$IFn$_invoke$arity$variadic = (function (t,p__29402){
var vec__29404 = p__29402;
var additional = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29404,(0),null);
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__29395_SHARP_),t);
});
}
}));
...
/** @this {Function} */
(rewrite_clj.zip.findz.tag_predicate.cljs$lang$applyTo = (function (seq29396){
var G__29397 = cljs.core.first(seq29396);
var seq29396__$1 = cljs.core.next(seq29396);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29397,seq29396__$1);
}));

rewrite_clj.zip.findz.position_in_range_QMARK_ = (function rewrite_clj$zip$findz$position_in_range_QMARK_(zloc,pos){
var vec__29423 = ((cljs.core.map_QMARK_(pos))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"row","row",-570139521).cljs$core$IFn$_invoke$arity$1(pos),new cljs.core.Keyword(null,"col","col",-1959363084).cljs$core$IFn$_invoke$arity$1(pos)], null):pos);
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29423,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29423,(1),null);
if((((r <= (0))) || ((c <= (0))))){
...
var vec__29436 = rewrite_clj.custom_zipper.core.position_span(zloc);
var vec__29439 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29436,(0),null);
var zstart_row = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29439,(0),null);
var zstart_col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29439,(1),null);
var vec__29443 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29436,(1),null);
var zend_row = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29443,(0),null);
var zend_col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29443,(1),null);
...
return cljs.core.last(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__29468_SHARP_){
var and__5043__auto__ = (p_QMARK_.cljs$core$IFn$_invoke$arity$1 ? p_QMARK_.cljs$core$IFn$_invoke$arity$1(p1__29468_SHARP_) : p_QMARK_.call(null,p1__29468_SHARP_));
if(cljs.core.truth_(and__5043__auto__)){
return rewrite_clj.zip.findz.position_in_range_QMARK_(p1__29468_SHARP_,pos);
} else {
return and__5043__auto__;
}
...
var G__29486 = zloc;
var G__29486__$1 = (((G__29486 == null))?null:(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__29486) : f.call(null,G__29486)));
if((G__29486__$1 == null)){
return null;
} else {
return rewrite_clj.zip.findz.find.cljs$core$IFn$_invoke$arity$3(G__29486__$1,f,p_QMARK_);
}
}));
...
return rewrite_clj.zip.findz.find.cljs$core$IFn$_invoke$arity$3(zloc,f,(function (p1__29490_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__29490_SHARP_),t);
}));
}));
...
return rewrite_clj.zip.findz.find_last_by_pos.cljs$core$IFn$_invoke$arity$3(zloc,pos,(function (p1__29497_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__29497_SHARP_),t);
}));
});
/**
...
var p_QMARK_ = ((cljs.core.set_QMARK_(v))?cljs.core.comp.cljs$core$IFn$_invoke$arity$2(v,rewrite_clj.zip.base.sexpr):(function (p1__29506_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.sexpr(p1__29506_SHARP_),v);
}));
