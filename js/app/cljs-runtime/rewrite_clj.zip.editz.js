...
import "./rewrite_clj.custom_zipper.utils.js";
...
import "./rewrite_clj.zip.removez.js";
...
return rewrite_clj.node.protocols.coerce((function (){var G__29407 = rewrite_clj.node.protocols.sexpr.cljs$core$IFn$_invoke$arity$2(node,opts);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__29407) : f.call(null,G__29407));
})());
});
});
/**
...
var len__5769__auto___29480 = arguments.length;
var i__5770__auto___29481 = (0);
while(true){
if((i__5770__auto___29481 < len__5769__auto___29480)){
args__5775__auto__.push((arguments[i__5770__auto___29481]));

var G__29482 = (i__5770__auto___29481 + (1));
i__5770__auto___29481 = G__29482;
continue;
} else {
}
break;
...
return rewrite_clj.custom_zipper.core.edit.cljs$core$IFn$_invoke$arity$variadic(zloc,rewrite_clj.zip.editz.node_editor(rewrite_clj.zip.options.get_opts(zloc)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (p1__29409_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(f,p1__29409_SHARP_,args);
})], 0));
}));
...
/** @this {Function} */
(rewrite_clj.zip.editz.edit.cljs$lang$applyTo = (function (seq29411){
var G__29412 = cljs.core.first(seq29411);
var seq29411__$1 = cljs.core.next(seq29411);
var G__29413 = cljs.core.first(seq29411__$1);
var seq29411__$2 = cljs.core.next(seq29411__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29412,G__29413,seq29411__$2);
}));
...
var e_SINGLEQUOTE_ = ((typeof e === 'string')?(str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(e) : str_fn.call(null,e)):(((e instanceof cljs.core.Keyword))?cljs.core.keyword.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__29452 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__29452) : str_fn.call(null,G__29452));
})()):(((e instanceof cljs.core.Symbol))?cljs.core.symbol.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__29456 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__29456) : str_fn.call(null,G__29456));
})()):null)));
...
var G__29467 = rewrite_clj.zip.base.tag(zloc);
var G__29467__$1 = (((G__29467 instanceof cljs.core.Keyword))?G__29467.fqn:null);
switch (G__29467__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__29460_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__29460_SHARP_)].join('');
}));
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(lines,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0)], null),(function (p1__29462_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__29462_SHARP_)].join('');
}));
}
}));
...
var G__29474 = rewrite_clj.zip.base.tag(zloc);
var G__29474__$1 = (((G__29474 instanceof cljs.core.Keyword))?G__29474.fqn:null);
switch (G__29474__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__29472_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__29472_SHARP_),cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join('');
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__29474__$1)].join('')));
