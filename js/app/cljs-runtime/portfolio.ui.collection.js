...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(parent_id,new cljs.core.Keyword(null,"collection","collection",-683361892).cljs$core$IFn$_invoke$arity$1(p1__29818_SHARP_));
});
});
...
var G__29833 = (((s instanceof cljs.core.Keyword))?cljs.core.name(s):s);
var G__29833__$1 = (((G__29833 == null))?null:clojure.string.split.cljs$core$IFn$_invoke$arity$2(G__29833,/\./));
var G__29833__$2 = (((G__29833__$1 == null))?null:cljs.core.last(G__29833__$1));
if((G__29833__$2 == null)){
return null;
} else {
return portfolio.homeless.title_case(G__29833__$2);
}
});
...
var G__29839 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),id,new cljs.core.Keyword(null,"title","title",636505583),portfolio.ui.collection.get_collection_title(cljs.core.last(path)),new cljs.core.Keyword(null,"kind","kind",-717265803),new cljs.core.Keyword(null,"package","package",1189062786)], null);
if(((1) < cljs.core.count(path))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__29839,new cljs.core.Keyword(null,"collection","collection",-683361892),portfolio.ui.collection.path__GT_id(cljs.core.drop_last.cljs$core$IFn$_invoke$arity$2((1),path)));
} else {
return G__29839;
}
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2(portfolio.ui.collection.ns__GT_path,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29838_SHARP_){
var or__5045__auto__ = (function (){var G__29841 = p1__29838_SHARP_;
var G__29841__$1 = (((G__29841 == null))?null:new cljs.core.Keyword(null,"collection","collection",-683361892).cljs$core$IFn$_invoke$arity$1(G__29841));
if((G__29841__$1 == null)){
return null;
} else {
return cljs.core.name(G__29841__$1);
}
})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return cljs.core.namespace(new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__29838_SHARP_));
}
}),scenes)));
});
portfolio.ui.collection.ensure_defaults = (function portfolio$ui$collection$ensure_defaults(collection,scenes){
var G__29846 = collection;
var G__29846__$1 = ((cljs.core.empty_QMARK_(new cljs.core.Keyword(null,"title","title",636505583).cljs$core$IFn$_invoke$arity$1(collection)))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__29846,new cljs.core.Keyword(null,"title","title",636505583),portfolio.ui.collection.get_collection_title(new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(collection))):G__29846);
if((new cljs.core.Keyword(null,"kind","kind",-717265803).cljs$core$IFn$_invoke$arity$1(collection) == null)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__29846__$1,new cljs.core.Keyword(null,"kind","kind",-717265803),(cljs.core.truth_(cljs.core.some(cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentHashSet.createAsIfByAssoc([new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(collection)]),new cljs.core.Keyword(null,"collection","collection",-683361892)),scenes))?new cljs.core.Keyword(null,"package","package",1189062786):new cljs.core.Keyword(null,"folder","folder",1515881736)));
} else {
return G__29846__$1;
}
});
...
var packages = (function (){var iter__5523__auto__ = (function portfolio$ui$collection$get_default_organization_$_iter__29902(s__29903){
return (new cljs.core.LazySeq(null,(function (){
var s__29903__$1 = s__29903;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__29903__$1);
if(temp__5804__auto__){
var s__29903__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__29903__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__29903__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__29905 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__29904 = (0);
while(true){
if((i__29904 < size__5522__auto__)){
var pkg = cljs.core._nth(c__5521__auto__,i__29904);
cljs.core.chunk_append(b__29905,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([pkg,cljs.core.get.cljs$core$IFn$_invoke$arity$2(existing,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(pkg))], 0)));

var G__30227 = (i__29904 + (1));
i__29904 = G__30227;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__29905),portfolio$ui$collection$get_default_organization_$_iter__29902(cljs.core.chunk_rest(s__29903__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__29905),null);
}
} else {
var pkg = cljs.core.first(s__29903__$2);
return cljs.core.cons(cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([pkg,cljs.core.get.cljs$core$IFn$_invoke$arity$2(existing,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(pkg))], 0)),portfolio$ui$collection$get_default_organization_$_iter__29902(cljs.core.rest(s__29903__$2)));
}
} else {
return null;
}
...
return cljs.core.set(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29862_SHARP_){
return portfolio.ui.collection.ensure_defaults(p1__29862_SHARP_,scenes);
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29861_SHARP_){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([p1__29861_SHARP_,cljs.core.get.cljs$core$IFn$_invoke$arity$2(existing,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__29861_SHARP_))], 0));
}),((((((1) < folder_n)) || (cljs.core.seq(configured_folders))))?cljs.core.concat.cljs$core$IFn$_invoke$arity$2(packages,folders):cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29860_SHARP_){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(p1__29860_SHARP_,new cljs.core.Keyword(null,"collection","collection",-683361892));
}),packages)))));
});
portfolio.ui.collection.get_collection_path = (function portfolio$ui$collection$get_collection_path(p__29943,id){
var map__29945 = p__29943;
var map__29945__$1 = cljs.core.__destructure_map(map__29945);
var scenes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29945__$1,new cljs.core.Keyword(null,"scenes","scenes",-425219404));
var collections = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29945__$1,new cljs.core.Keyword(null,"collections","collections",-2114643505));
...
var G__30304 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(res,cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentHashSet.createAsIfByAssoc([parent_id]),new cljs.core.Keyword(null,"id","id",-1388402092)),cljs.core.vals(collections))));
res = G__30304;
continue;
} else {
return res;
...
portfolio.ui.collection.get_collection_scenes = (function portfolio$ui$collection$get_collection_scenes(p__29965,ids){
var map__29966 = p__29965;
var map__29966__$1 = cljs.core.__destructure_map(map__29966);
var collections = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29966__$1,new cljs.core.Keyword(null,"collections","collections",-2114643505));
var scenes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29966__$1,new cljs.core.Keyword(null,"scenes","scenes",-425219404));
var res = cljs.core.PersistentVector.EMPTY;
var ids__$1 = cljs.core.set(ids);
while(true){
if(cljs.core.seq(ids__$1)){
var G__30323 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(res,cljs.core.filter.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2(ids__$1,new cljs.core.Keyword(null,"collection","collection",-683361892)),cljs.core.vals(scenes)));
var G__30324 = cljs.core.set(cljs.core.map.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"id","id",-1388402092),cljs.core.filter.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2(ids__$1,new cljs.core.Keyword(null,"collection","collection",-683361892)),cljs.core.vals(collections))));
res = G__30323;
ids__$1 = G__30324;
continue;
} else {
...
portfolio.ui.collection.get_selected_scenes = (function portfolio$ui$collection$get_selected_scenes(p__29994,id){
var map__29995 = p__29994;
var map__29995__$1 = cljs.core.__destructure_map(map__29995);
var state = map__29995__$1;
var scenes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29995__$1,new cljs.core.Keyword(null,"scenes","scenes",-425219404));
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$2(collection,(999999999)),(function (){var or__5045__auto__ = (function (){var G__30028 = collection;
var G__30028__$1 = (((G__30028 == null))?null:new cljs.core.Keyword(null,"title","title",636505583).cljs$core$IFn$_invoke$arity$1(G__30028));
if((G__30028__$1 == null)){
return null;
} else {
return clojure.string.lower_case(G__30028__$1);
}
})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
var G__30029 = collection;
var G__30029__$1 = (((G__30029 == null))?null:new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(G__30029));
if((G__30029__$1 == null)){
return null;
} else {
return cljs.core.name(G__30029__$1);
}
}
})()], null);
});
...
var G__30345 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"collections","collections",-2114643505),id], null));
m__$1 = G__30345;
continue;
} else {
...
var i__5770__auto___30396 = (0);
while(true){
if((i__5770__auto___30396 < len__5769__auto___30394)){
args__5775__auto__.push((arguments[i__5770__auto___30396]));

var G__30401 = (i__5770__auto___30396 + (1));
i__5770__auto___30396 = G__30401;
continue;
} else {
}
break;
...
(portfolio.ui.collection.get_illustration.cljs$core$IFn$_invoke$arity$variadic = (function (item,state,p__30102){
var vec__30103 = p__30102;
var current_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30103,(0),null);
var G__30106 = new cljs.core.Keyword(null,"kind","kind",-717265803).cljs$core$IFn$_invoke$arity$1(item);
...
/** @this {Function} */
(portfolio.ui.collection.get_illustration.cljs$lang$applyTo = (function (seq30088){
var G__30089 = cljs.core.first(seq30088);
var seq30088__$1 = cljs.core.next(seq30088);
var G__30090 = cljs.core.first(seq30088__$1);
var seq30088__$2 = cljs.core.next(seq30088__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30089,G__30090,seq30088__$2);
}));

portfolio.ui.collection.prepare_selection_menu_bar = (function portfolio$ui$collection$prepare_selection_menu_bar(state,selection,p__30133){
var map__30135 = p__30133;
var map__30135__$1 = cljs.core.__destructure_map(map__30135);
var expand_path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30135__$1,new cljs.core.Keyword(null,"expand-path","expand-path",-436455836));
var location__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30135__$1,new cljs.core.Keyword(null,"location","location",1815599388));
var tight_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30135__$1,new cljs.core.Keyword(null,"tight?","tight?",1625746895));
return new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"title","title",636505583),(cljs.core.truth_(tight_QMARK_)?new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"text","text",-1790561697),new cljs.core.Keyword(null,"title","title",636505583).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"target","target",253001721).cljs$core$IFn$_invoke$arity$1(selection))], null)], null):(function (){var iter__5523__auto__ = (function portfolio$ui$collection$prepare_selection_menu_bar_$_iter__30136(s__30137){
return (new cljs.core.LazySeq(null,(function (){
var s__30137__$1 = s__30137;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__30137__$1);
if(temp__5804__auto__){
var s__30137__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__30137__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__30137__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__30139 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__30138 = (0);
while(true){
if((i__30138 < size__5522__auto__)){
var item = cljs.core._nth(c__5521__auto__,i__30138);
cljs.core.chunk_append(b__30139,(function (){var G__30145 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"text","text",-1790561697),new cljs.core.Keyword(null,"title","title",636505583).cljs$core$IFn$_invoke$arity$1(item)], null);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__30145,new cljs.core.Keyword(null,"url","url",276297046),portfolio.ui.routes.get_url.cljs$core$IFn$_invoke$arity$2(location__$1,item));
} else {
return G__30145;
}
})());

var G__30411 = (i__30138 + (1));
i__30138 = G__30411;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__30139),portfolio$ui$collection$prepare_selection_menu_bar_$_iter__30136(cljs.core.chunk_rest(s__30137__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__30139),null);
}
} else {
var item = cljs.core.first(s__30137__$2);
return cljs.core.cons((function (){var G__30158 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"text","text",-1790561697),new cljs.core.Keyword(null,"title","title",636505583).cljs$core$IFn$_invoke$arity$1(item)], null);
if(cljs.core.truth_((function (){var and__5043__auto__ = cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"target","target",253001721).cljs$core$IFn$_invoke$arity$1(selection),item);
if(and__5043__auto__){
return location__$1;
} else {
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__30158,new cljs.core.Keyword(null,"url","url",276297046),portfolio.ui.routes.get_url.cljs$core$IFn$_invoke$arity$2(location__$1,item));
} else {
return G__30158;
}
})(),portfolio$ui$collection$prepare_selection_menu_bar_$_iter__30136(cljs.core.rest(s__30137__$2)));
}
} else {
return null;
}
