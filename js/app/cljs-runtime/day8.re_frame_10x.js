...
import "./day8.re_frame_10x.inlined_deps.spade.git_sha_93ef290.react.js";
import "./day8.reagent.impl.batching.js";
import "./day8.reagent.impl.component.js";
...
import "./day8.re_frame_10x.tools.shadow_dom.js";
import "./day8.re_frame_10x.components.re_com.js";
import "./day8.re_frame_10x.navigation.views.js";
...
var width_PERCENT__30369 = ((new_window_width - x) / new_window_width);
if((width_PERCENT__30369 <= 0.9)){
day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.settings.events","panel-width%","day8.re-frame-10x.panels.settings.events/panel-width%",-569115915),width_PERCENT__30369], null));
} else {
}
...
var trace = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__30345_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(trace_id,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__30345_SHARP_));
...
var view = (function (p1__30359_SHARP_){
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ns","ns",441598760),p1__30359_SHARP_,new cljs.core.Keyword(null,"ns-str","ns-str",-2062616499),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__30359_SHARP_)], null);
});
var alias = (function (p__30360){
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,keep_vals,new cljs.core.PersistentArrayMap(null, 8, [new cljs.core.Keyword(null,"debug?","debug?",-1831756173),day8.re_frame_10x.debug_QMARK_,new cljs.core.Keyword(null,"retained-epochs","retained-epochs",1350238734),day8.re_frame_10x.history_size,new cljs.core.Keyword(null,"ignored-events","ignored-events",1738756589),(function (){var G__30364 = day8.re_frame_10x.ignored_events;
var G__30364__$1 = (((G__30364 == null))?null:(read.cljs$core$IFn$_invoke$arity$1 ? read.cljs$core$IFn$_invoke$arity$1(G__30364) : read.call(null,G__30364)));
if((G__30364__$1 == null)){
return null;
} else {
return day8.re_frame_10x.tools.coll.sortable_uuid_map(G__30364__$1);
}
})(),new cljs.core.Keyword(null,"filtered-view-trace","filtered-view-trace",-901876599),(function (){var G__30365 = day8.re_frame_10x.hidden_namespaces;
var G__30365__$1 = (((G__30365 == null))?null:(read.cljs$core$IFn$_invoke$arity$1 ? read.cljs$core$IFn$_invoke$arity$1(G__30365) : read.call(null,G__30365)));
var G__30365__$2 = (((G__30365__$1 == null))?null:cljs.core.map.cljs$core$IFn$_invoke$arity$2(view,G__30365__$1));
if((G__30365__$2 == null)){
return null;
} else {
return day8.re_frame_10x.tools.coll.sortable_uuid_map(G__30365__$2);
}
})(),new cljs.core.Keyword(null,"app-db-follows-events?","app-db-follows-events?",-1566738462),day8.re_frame_10x.time_travel_QMARK_,new cljs.core.Keyword(null,"low-level-trace","low-level-trace",638447092),(function (){var G__30366 = day8.re_frame_10x.ignored_libs;
var G__30366__$1 = (((G__30366 == null))?null:(read.cljs$core$IFn$_invoke$arity$1 ? read.cljs$core$IFn$_invoke$arity$1(G__30366) : read.call(null,G__30366)));
if((G__30366__$1 == null)){
return null;
} else {
return day8.re_frame_10x.tools.coll.pred_map(G__30366__$1,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"re-frame","re-frame",-1039473033),null,new cljs.core.Keyword(null,"reagent","reagent",2131627322),null], null), null));
}
})(),new cljs.core.Keyword(null,"ns-aliases","ns-aliases",1290254821),(function (){var G__30367 = day8.re_frame_10x.ns_aliases;
var G__30367__$1 = (((G__30367 == null))?null:(read.cljs$core$IFn$_invoke$arity$1 ? read.cljs$core$IFn$_invoke$arity$1(G__30367) : read.call(null,G__30367)));
var G__30367__$2 = (((G__30367__$1 == null))?null:cljs.core.map.cljs$core$IFn$_invoke$arity$2(alias,G__30367__$1));
if((G__30367__$2 == null)){
return null;
} else {
return day8.re_frame_10x.tools.coll.sortable_uuid_map(G__30367__$2);
}
})(),new cljs.core.Keyword(null,"trace-when","trace-when",-1902271347),(function (){var G__30368 = day8.re_frame_10x.trace_when;
var G__30368__$1 = (((G__30368 == null))?null:(read.cljs$core$IFn$_invoke$arity$1 ? read.cljs$core$IFn$_invoke$arity$1(G__30368) : read.call(null,G__30368)));
if((G__30368__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__30368__$1);
}
})()], null));
})();
