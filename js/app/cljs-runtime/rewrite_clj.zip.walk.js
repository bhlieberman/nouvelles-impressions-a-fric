...
var G__29509 = rewrite_clj.zip.move.next(rewrite_clj.zip.walk.process_loc(loc,p_QMARK_,f));
loc = G__29509;
continue;
}
break;
...
var G__29513 = rewrite_clj.zip.walk.downmost(rewrite_clj.zip.move.right(loc__$1));
loc = G__29513;
continue;
} else {
if(cljs.core.truth_(rewrite_clj.zip.move.up(loc__$1))){
var G__29514 = rewrite_clj.zip.move.up(loc__$1);
loc = G__29514;
continue;
} else {
return loc__$1;
...
return rewrite_clj.zip.subedit.subedit_node(zloc,(function (p1__29502_SHARP_){
return rewrite_clj.zip.walk.postwalk_subtree(p_QMARK_,f,p1__29502_SHARP_);
}));
}));
