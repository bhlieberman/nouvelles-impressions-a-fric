...
import "./day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.input.js";
...
var G__14581 = o;
day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.goog$module$goog$object.set(G__14581,day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.cached_prop_name(k),(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__14602__delegate = function (args){
...
while (G__14603__i < G__14603__a.length) {G__14603__a[G__14603__i] = arguments[G__14603__i + 0]; ++G__14603__i;}
  args = new cljs.core.IndexedSeq(G__14603__a,0,null);
} 
return G__14602__delegate.call(this,args);};
...
return G__14602__delegate(args);
});
...
var G__14582 = o;
day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.goog$module$goog$object.set(G__14582,day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.cached_custom_prop_name(k),day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.convert_prop_value(v));
...
while (G__14606__i < G__14606__a.length) {G__14606__a[G__14606__i] = arguments[G__14606__i + 0]; ++G__14606__i;}
  args = new cljs.core.IndexedSeq(G__14606__a,0,null);
} 
...
var G__14585 = props;
var G__14585__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__14585,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__14585);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__14585__$1,new cljs.core.Keyword(null,"class","class",-2030961996),day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.set_id_class((function (){var G__14586 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__14586,new cljs.core.Keyword(null,"class","class",-2030961996),day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__14586;
}
})(),id_class);
...
var G__14587 = (cljs.core.count(argv) - first_child);
switch (G__14587) {
case (0):
...
var vec__14588 = cljs.core.next(cljs.core.re_matches(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14588,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14588,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14588,(2),null);
...
var temp__5808__auto___14617 = day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___14617 == null)){
} else {
var key_14618 = temp__5808__auto___14617;
(jsprops.key = key_14618);
}
...
var temp__5808__auto___14619 = day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___14619 == null)){
} else {
var key_14620 = temp__5808__auto___14619;
(jsprops.key = key_14620);
}
...
var temp__5808__auto___14621 = day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___14621 == null)){
} else {
var key_14623 = temp__5808__auto___14621;
(jsprops.key = key_14623);
}
...
var temp__5808__auto___14627 = day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___14627 == null)){
} else {
var key_14628 = temp__5808__auto___14627;
(jsprops.key = key_14628);
}
...
var temp__5808__auto___14629 = day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___14629 == null)){
} else {
var key_14630 = temp__5808__auto___14629;
(jsprops.key = key_14630);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__14591_SHARP_){
return day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.protocols.as_element(compiler,p1__14591_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__14592 = day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.ratom.check_derefs((function (){
return day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14592,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14592,(1),null);
...
break;
default:
var G__14639 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__14640 = compiler;
v = G__14639;
compiler = G__14640;
continue;
...
*/
day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template14599 = (function (opts,id,fn_to_element,parse_fn,meta14600){
this.opts = opts;
this.id = id;
...
(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template14599.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_14601,meta14600__$1){
var self__ = this;
var _14601__$1 = this;
return (new day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template14599(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta14600__$1));
}));

(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template14599.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_14601){
var self__ = this;
var _14601__$1 = this;
return self__.meta14600;
}));

(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template14599.prototype.day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template14599.prototype.day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template14599.prototype.day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template14599.prototype.day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template14599.prototype.day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
...
(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template14599.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta14600","meta14600",-415521409,null)], null);
}));

(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template14599.cljs$lang$type = true);

(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template14599.cljs$lang$ctorStr = "day8.re-frame-10x.inlined-deps.reagent.v1v2v0.reagent.impl.template/t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template14599");

(day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template14599.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"day8.re-frame-10x.inlined-deps.reagent.v1v2v0.reagent.impl.template/t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template14599");
}));

/**
 * Positional factory function for day8.re-frame-10x.inlined-deps.reagent.v1v2v0.reagent.impl.template/t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template14599.
 */
day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.__GT_t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template14599 = (function day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template$__GT_t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template14599(opts,id,fn_to_element,parse_fn,meta14600){
return (new day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template14599(opts,id,fn_to_element,parse_fn,meta14600));
});
...
return (new day8.re_frame_10x.inlined_deps.reagent.v1v2v0.reagent.impl.template.t_day8$re_frame_10x$inlined_deps$reagent$v1v2v0$reagent$impl$template14599(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
