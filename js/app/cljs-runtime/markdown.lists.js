...
return clojure.string.join.cljs$core$IFn$_invoke$arity$1((function (){var iter__5523__auto__ = (function markdown$lists$close_lists_$_iter__29894(s__29895){
return (new cljs.core.LazySeq(null,(function (){
var s__29895__$1 = s__29895;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__29895__$1);
if(temp__5804__auto__){
var s__29895__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__29895__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__29895__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__29898 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__29897 = (0);
while(true){
if((i__29897 < size__5522__auto__)){
var vec__29929 = cljs.core._nth(c__5521__auto__,i__29897);
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29929,(0),null);
cljs.core.chunk_append(b__29898,["</li></",cljs.core.name(list_type),">"].join(''));

var G__30009 = (i__29897 + (1));
i__29897 = G__30009;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__29898),markdown$lists$close_lists_$_iter__29894(cljs.core.chunk_rest(s__29895__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__29898),null);
}
} else {
var vec__29936 = cljs.core.first(s__29895__$2);
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29936,(0),null);
return cljs.core.cons(["</li></",cljs.core.name(list_type),">"].join(''),markdown$lists$close_lists_$_iter__29894(cljs.core.rest(s__29895__$2)));
}
} else {
return null;
}
...
var lists_to_close = cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__29939_SHARP_){
return (cljs.core.second(p1__29939_SHARP_) > num_indents);
...
var vec__29949 = cljs.core.last(new cljs.core.Keyword(null,"lists","lists",-884730684).cljs$core$IFn$_invoke$arity$1(state));
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29949,(0),null);
var indents = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29949,(1),null);
...
var vec__29959 = cljs.core.last(new cljs.core.Keyword(null,"lists","lists",-884730684).cljs$core$IFn$_invoke$arity$1(state));
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29959,(0),null);
var indents = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29959,(1),null);
var num_indents = cljs.core.count(cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core._EQ_," "),text));
...
markdown.lists.li = (function markdown$lists$li(text,p__29983){
var map__29993 = p__29983;
var map__29993__$1 = cljs.core.__destructure_map(map__29993);
var state = map__29993__$1;
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29993__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var last_line_empty_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29993__$1,new cljs.core.Keyword(null,"last-line-empty?","last-line-empty?",1279111527));
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29993__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29993__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
