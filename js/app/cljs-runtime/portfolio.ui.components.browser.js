...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ul","ul",-1349521403),attrs,(function (){var iter__5523__auto__ = (function portfolio$ui$components$browser$iter__31720(s__31721){
return (new cljs.core.LazySeq(null,(function (){
var s__31721__$1 = s__31721;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__31721__$1);
if(temp__5804__auto__){
var s__31721__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__31721__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__31721__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__31723 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__31722 = (0);
while(true){
if((i__31722 < size__5522__auto__)){
var item = cljs.core._nth(c__5521__auto__,i__31722);
cljs.core.chunk_append(b__31723,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),(portfolio.ui.components.browser.render_menu.cljs$core$IFn$_invoke$arity$1 ? portfolio.ui.components.browser.render_menu.cljs$core$IFn$_invoke$arity$1(item) : portfolio.ui.components.browser.render_menu.call(null,item))], null));

var G__31826 = (i__31722 + (1));
i__31722 = G__31826;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__31723),portfolio$ui$components$browser$iter__31720(cljs.core.chunk_rest(s__31721__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__31723),null);
}
} else {
var item = cljs.core.first(s__31721__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),(portfolio.ui.components.browser.render_menu.cljs$core$IFn$_invoke$arity$1 ? portfolio.ui.components.browser.render_menu.cljs$core$IFn$_invoke$arity$1(item) : portfolio.ui.components.browser.render_menu.call(null,item))], null),portfolio$ui$components$browser$iter__31720(cljs.core.rest(s__31721__$2)));
}
} else {
return null;
}
...
var G__31767 = pair;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"folder","folder",1515881736),new cljs.core.Keyword(null,"folder","folder",1515881736)], null),G__31767)){
return (24);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"folder","folder",1515881736),new cljs.core.Keyword(null,"package","package",1189062786)], null),G__31767)){
return (0);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"package","package",1189062786),new cljs.core.Keyword(null,"folder","folder",1515881736)], null),G__31767)){
return (24);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"package","package",1189062786),new cljs.core.Keyword(null,"package","package",1189062786)], null),G__31767)){
return (24);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"folder","folder",1515881736),new cljs.core.Keyword(null,"unit","unit",375175175)], null),G__31767)){
return (8);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"package","package",1189062786),new cljs.core.Keyword(null,"unit","unit",375175175)], null),G__31767)){
return (48);
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__31767)].join('')));
 ...
 * 
 */
portfolio.ui.components.browser.Folder = (function (){var G__31773 = (function (p__31778){
var map__31779 = p__31778;
var map__31779__$1 = cljs.core.__destructure_map(map__31779);
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31779__$1,new cljs.core.Keyword(null,"title","title",636505583));
var illustration = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31779__$1,new cljs.core.Keyword(null,"illustration","illustration",-48860973));
var actions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31779__$1,new cljs.core.Keyword(null,"actions","actions",-812656882));
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31779__$1,new cljs.core.Keyword(null,"items","items",1031954938));
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31779__$1,new cljs.core.Keyword(null,"context","context",-830191113));
...
var G__31774 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"name","name",1843675177),"portfolio.ui.components.browser/Folder"], null);
return (dumdom.core.component.cljs$core$IFn$_invoke$arity$2 ? dumdom.core.component.cljs$core$IFn$_invoke$arity$2(G__31773,G__31774) : dumdom.core.component.call(null,G__31773,G__31774));
})();
/**
 * 
 */
portfolio.ui.components.browser.Package = (function (){var G__31790 = (function (p__31792){
var map__31793 = p__31792;
var map__31793__$1 = cljs.core.__destructure_map(map__31793);
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31793__$1,new cljs.core.Keyword(null,"title","title",636505583));
var illustration = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31793__$1,new cljs.core.Keyword(null,"illustration","illustration",-48860973));
var actions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31793__$1,new cljs.core.Keyword(null,"actions","actions",-812656882));
var toggle = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31793__$1,new cljs.core.Keyword(null,"toggle","toggle",1291842030));
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31793__$1,new cljs.core.Keyword(null,"items","items",1031954938));
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31793__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var selected_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31793__$1,new cljs.core.Keyword(null,"selected?","selected?",-742502788));
...
var G__31791 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"name","name",1843675177),"portfolio.ui.components.browser/Package"], null);
return (dumdom.core.component.cljs$core$IFn$_invoke$arity$2 ? dumdom.core.component.cljs$core$IFn$_invoke$arity$2(G__31790,G__31791) : dumdom.core.component.call(null,G__31790,G__31791));
})();
/**
 * 
 */
portfolio.ui.components.browser.Unit = (function (){var G__31800 = (function (p__31802){
var map__31803 = p__31802;
var map__31803__$1 = cljs.core.__destructure_map(map__31803);
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31803__$1,new cljs.core.Keyword(null,"title","title",636505583));
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31803__$1,new cljs.core.Keyword(null,"url","url",276297046));
var actions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31803__$1,new cljs.core.Keyword(null,"actions","actions",-812656882));
var selected_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31803__$1,new cljs.core.Keyword(null,"selected?","selected?",-742502788));
var illustration = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31803__$1,new cljs.core.Keyword(null,"illustration","illustration",-48860973));
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31803__$1,new cljs.core.Keyword(null,"context","context",-830191113));
...
var G__31801 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"name","name",1843675177),"portfolio.ui.components.browser/Unit"], null);
return (dumdom.core.component.cljs$core$IFn$_invoke$arity$2 ? dumdom.core.component.cljs$core$IFn$_invoke$arity$2(G__31800,G__31801) : dumdom.core.component.call(null,G__31800,G__31801));
})();
portfolio.ui.components.browser.render_menu = (function portfolio$ui$components$browser$render_menu(props){
var G__31820 = new cljs.core.Keyword(null,"kind","kind",-717265803).cljs$core$IFn$_invoke$arity$1(props);
var G__31820__$1 = (((G__31820 instanceof cljs.core.Keyword))?G__31820.fqn:null);
switch (G__31820__$1) {
case "folder":
