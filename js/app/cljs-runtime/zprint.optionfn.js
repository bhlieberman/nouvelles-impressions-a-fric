...
var zloc_seq_nc = (function (){var G__34934 = cljs.core.identity;
var G__34935 = new cljs.core.Keyword(null,"zloc","zloc",-2123059767).cljs$core$IFn$_invoke$arity$1(opts);
var fexpr__34933 = new cljs.core.Keyword(null,"zmap-no-comment","zmap-no-comment",1484161325).cljs$core$IFn$_invoke$arity$1(zfn_map);
...
var meta_seq = (function (){var fexpr__34936 = new cljs.core.Keyword(null,"zmap-no-comment","zmap-no-comment",1484161325).cljs$core$IFn$_invoke$arity$1(zfn_map);
return (fexpr__34936.cljs$core$IFn$_invoke$arity$2 ? fexpr__34936.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,meta_zloc) : fexpr__34936.call(null,cljs.core.identity,meta_zloc));
})();
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"meta","meta",1499536964),(function (){var G__34938 = cljs.core.second(meta_seq);
var fexpr__34937 = new cljs.core.Keyword(null,"ztag","ztag",125694964).cljs$core$IFn$_invoke$arity$1(zfn_map);
return (fexpr__34937.cljs$core$IFn$_invoke$arity$1 ? fexpr__34937.cljs$core$IFn$_invoke$arity$1(G__34938) : fexpr__34937.call(null,G__34938));
})())){
return null;
} else {
...
var result = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__34976_SHARP_,p2__34975_SHARP_){
if(cljs.core.truth_(cljs.core.re_find(cljs.core.first(p2__34975_SHARP_),fn_str))){
return cljs.core.reduced(cljs.core.second(p2__34975_SHARP_));
} else {
return null;
}
}),null,rule_pairs);
...
var fn_str = cljs.core.str.cljs$core$IFn$_invoke$arity$1(fn_name);
var rule_pairs = cljs.core.partition.cljs$core$IFn$_invoke$arity$4((2),(2),cljs.core.repeat.cljs$core$IFn$_invoke$arity$1(null),rules_vec);
var result = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__34986_SHARP_,p2__34985_SHARP_){
var lhs = cljs.core.first(p2__34985_SHARP_);
...
return cljs.core.reduced(cljs.core.second(p2__34985_SHARP_));
} else {
return null;
}
} else {
if(cljs.core.truth_(cljs.core.re_find(cljs.core.first(p2__34985_SHARP_),fn_str))){
return cljs.core.reduced(cljs.core.second(p2__34985_SHARP_));
} else {
return null;
}
