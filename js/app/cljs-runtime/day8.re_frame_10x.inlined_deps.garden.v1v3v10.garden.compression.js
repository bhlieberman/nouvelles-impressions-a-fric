 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v10.garden.compression.token_fn = (function day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$compression$token_fn(p__15577){
var vec__15579 = p__15577;
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15579,(0),null);
var re = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15579,(1),null);
return (function (s){
...
var len__5769__auto___15610 = arguments.length;
var i__5770__auto___15611 = (0);
while(true){
if((i__5770__auto___15611 < len__5769__auto___15610)){
args__5775__auto__.push((arguments[i__5770__auto___15611]));

var G__15612 = (i__5770__auto___15611 + (1));
i__5770__auto___15611 = G__15612;
continue;
} else {
}
break;
...
return (function (s){
return cljs.core.some((function (p1__15584_SHARP_){
return (p1__15584_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__15584_SHARP_.cljs$core$IFn$_invoke$arity$1(s) : p1__15584_SHARP_.call(null,s));
}),fs);
});
}));
...
/** @this {Function} */
(day8.re_frame_10x.inlined_deps.garden.v1v3v10.garden.compression.tokenizer.cljs$lang$applyTo = (function (seq15585){
...
var map__15594 = temp__5802__auto__;
var map__15594__$1 = cljs.core.__destructure_map(map__15594);
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15594__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15594__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15594__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__15620 = cljs.core.subs.cljs$core$IFn$_invoke$arity$2(s1,size);
var G__15621 = [s2,cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__15597 = tag;
