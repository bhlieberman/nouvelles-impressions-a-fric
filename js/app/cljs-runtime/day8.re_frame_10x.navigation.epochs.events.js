...
import "./day8.re_frame_10x.fx.debounce.js";
import "./day8.re_frame_10x.fx.scroll.js";
...
day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("day8.re-frame-10x.navigation.epochs.events","scroll-into-view-debounced","day8.re-frame-10x.navigation.epochs.events/scroll-into-view-debounced",-416908306),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.trim_v], null),(function (_,p__18054){
var vec__18055 = p__18054;
var js_dom = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18055,(0),null);
...
day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("day8.re-frame-10x.navigation.epochs.events","scroll-into-view","day8.re-frame-10x.navigation.epochs.events/scroll-into-view",-1183173127),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.trim_v], null),(function (_,p__18058){
var vec__18059 = p__18058;
var js_dom = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18059,(0),null);
...
day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("day8.re-frame-10x.navigation.epochs.events","receive-new-traces","day8.re-frame-10x.navigation.epochs.events/receive-new-traces",542616228),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.trim_v], null),(function (p__18063,p__18064){
var map__18065 = p__18063;
var map__18065__$1 = cljs.core.__destructure_map(map__18065);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18065__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__18066 = p__18064;
var new_traces = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18066,(0),null);
...
var map__18069 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(db,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"settings","settings",1556144875),new cljs.core.Keyword(null,"low-level-trace","low-level-trace",638447092)], null));
var map__18069__$1 = cljs.core.__destructure_map(map__18069);
var drop_re_frame = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18069__$1,new cljs.core.Keyword(null,"re-frame","re-frame",-1039473033));
var drop_reagent = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18069__$1,new cljs.core.Keyword(null,"reagent","reagent",2131627322));
...
var retained_traces = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.drop_while.cljs$core$IFn$_invoke$arity$1((function (p1__18062_SHARP_){
return (new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__18062_SHARP_) < first_id_to_retain);
...
var G__18080 = new cljs.core.Keyword(null,"selected-epoch-id","selected-epoch-id",70601778).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"epochs","epochs",1796936425).cljs$core$IFn$_invoke$arity$1(db));
var fexpr__18079 = cljs.core.PersistentHashSet.createAsIfByAssoc([day8.re_frame_10x.navigation.epochs.events.first_match_id(cljs.core.last(previous_matches))]);
return (fexpr__18079.cljs$core$IFn$_invoke$arity$1 ? fexpr__18079.cljs$core$IFn$_invoke$arity$1(G__18080) : fexpr__18079.call(null,G__18080));
}
} else {
return and__5043__auto__;
}
})();
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"db","db",993250759),(function (){var G__18082 = cljs.core.update.cljs$core$IFn$_invoke$arity$variadic(cljs.core.assoc_in(db,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"traces","traces",-1301138004),new cljs.core.Keyword(null,"all","all",892129742)], null),retained_traces),new cljs.core.Keyword(null,"epochs","epochs",1796936425),cljs.core.assoc,new cljs.core.Keyword(null,"matches","matches",635497998),retained_matches,new cljs.core.Keyword(null,"match-ids","match-ids",752973161),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([match_ids,new cljs.core.Keyword(null,"matches-by-id","matches-by-id",1749529562),cljs.core.zipmap(match_ids,retained_matches),new cljs.core.Keyword(null,"parse-state","parse-state",-1931312535),parse_state__$2,new cljs.core.Keyword(null,"sub-state","sub-state",-2129237981),new_sub_state,new cljs.core.Keyword(null,"subscription-info","subscription-info",-1785424092),subscription_info], 0));
if(cljs.core.truth_(select_latest_QMARK_)){
return cljs.core.assoc_in(G__18082,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"epochs","epochs",1796936425),new cljs.core.Keyword(null,"selected-epoch-id","selected-epoch-id",70601778)], null),cljs.core.last(match_ids));
} else {
return G__18082;
}
...
day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("day8.re-frame-10x.navigation.epochs.events","previous","day8.re-frame-10x.navigation.epochs.events/previous",2061328788),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"epochs","epochs",1796936425)], null)], 0))], null),(function (p__18083,_){
var map__18084 = p__18083;
var map__18084__$1 = cljs.core.__destructure_map(map__18084);
var map__18085 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18084__$1,new cljs.core.Keyword(null,"db","db",993250759));
var map__18085__$1 = cljs.core.__destructure_map(map__18085);
var db = map__18085__$1;
var match_ids = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18085__$1,new cljs.core.Keyword(null,"match-ids","match-ids",752973161));
var selected_epoch_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18085__$1,new cljs.core.Keyword(null,"selected-epoch-id","selected-epoch-id",70601778));
...
day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("day8.re-frame-10x.navigation.epochs.events","next","day8.re-frame-10x.navigation.epochs.events/next",1388476595),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"epochs","epochs",1796936425)], null)], 0))], null),(function (p__18086,_){
var map__18087 = p__18086;
var map__18087__$1 = cljs.core.__destructure_map(map__18087);
var map__18088 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18087__$1,new cljs.core.Keyword(null,"db","db",993250759));
var map__18088__$1 = cljs.core.__destructure_map(map__18088);
var db = map__18088__$1;
var match_ids = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18088__$1,new cljs.core.Keyword(null,"match-ids","match-ids",752973161));
var selected_epoch_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18088__$1,new cljs.core.Keyword(null,"selected-epoch-id","selected-epoch-id",70601778));
...
day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("day8.re-frame-10x.navigation.epochs.events","most-recent","day8.re-frame-10x.navigation.epochs.events/most-recent",-1146993774),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"epochs","epochs",1796936425)], null)], 0))], null),(function (p__18091,_){
var map__18092 = p__18091;
var map__18092__$1 = cljs.core.__destructure_map(map__18092);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18092__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("day8.re-frame-10x.navigation.epochs.events","load","day8.re-frame-10x.navigation.epochs.events/load",1738587584),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"epochs","epochs",1796936425)], null)], 0)),day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.trim_v], null),(function (p__18095,p__18096){
var map__18098 = p__18095;
var map__18098__$1 = cljs.core.__destructure_map(map__18098);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18098__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__18100 = p__18096;
var new_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18100,(0),null);
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"db","db",993250759),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(db,new cljs.core.Keyword(null,"selected-epoch-id","selected-epoch-id",70601778),new_id),new cljs.core.Keyword(null,"dispatch","dispatch",1319337009),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.navigation.epochs.events","reset-current-epoch-app-db","day8.re-frame-10x.navigation.epochs.events/reset-current-epoch-app-db",1850636212),new_id], null)], null);
}));
...
day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("day8.re-frame-10x.navigation.epochs.events","reset-current-epoch-app-db","day8.re-frame-10x.navigation.epochs.events/reset-current-epoch-app-db",1850636212),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.trim_v], null),(function (db,p__18113){
var vec__18114 = p__18113;
var new_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18114,(0),null);
...
var epochs_18186 = new cljs.core.Keyword(null,"epochs","epochs",1796936425).cljs$core$IFn$_invoke$arity$1(db);
var match_id_18187 = (function (){var or__5045__auto__ = new_id;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return day8.re_frame_10x.tools.coll.last_in_vec(cljs.core.get.cljs$core$IFn$_invoke$arity$2(epochs_18186,new cljs.core.Keyword(null,"match-ids","match-ids",752973161)));
}
})();
var match_18188 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(epochs_18186,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"matches-by-id","matches-by-id",1749529562),match_id_18187], null));
var event_18189 = day8.re_frame_10x.tools.metamorphic.matched_event(new cljs.core.Keyword(null,"match-info","match-info",666319879).cljs$core$IFn$_invoke$arity$1(match_18188));
var temp__5808__auto___18195 = day8.re_frame_10x.tools.metamorphic.app_db_after(event_18189);
if((temp__5808__auto___18195 == null)){
} else {
var new_db_18197 = temp__5808__auto___18195;
cljs.core.reset_BANG_(re_frame.db.app_db,new_db_18197);
}
} else {
}
...
day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("day8.re-frame-10x.navigation.epochs.events","set-filter","day8.re-frame-10x.navigation.epochs.events/set-filter",1725152200),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"epochs","epochs",1796936425),new cljs.core.Keyword(null,"filter-str","filter-str",1974484789)], null)], 0)),day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.trim_v], null),(function (_,p__18124){
var vec__18125 = p__18124;
var filter_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18125,(0),null);
return filter_str;
}));
