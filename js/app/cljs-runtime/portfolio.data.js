...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__28693){
var vec__28694 = p__28693;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28694,(0),null);
var scenes__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28694,(1),null);
return cljs.core.keep.cljs$core$IFn$_invoke$arity$2(cljs.core.second,cljs.core.drop_while.cljs$core$IFn$_invoke$arity$2((function (p__28697){
var vec__28698 = p__28697;
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28698,(0),null);
var b = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28698,(1),null);
...
var map__28701 = portfolio.data.get_scene_context(cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(portfolio.data.scenes),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(scene)], null)),scene);
var map__28701__$1 = cljs.core.__destructure_map(map__28701);
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28701__$1,new cljs.core.Keyword(null,"idx","idx",1053688473));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28701__$1,new cljs.core.Keyword(null,"line","line",212345235));
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(portfolio.data.scenes,cljs.core.assoc,new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(scene),(function (){var G__28702 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(scene,new cljs.core.Keyword(null,"param","param",2013631823)),new cljs.core.Keyword(null,"line","line",212345235),line,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"idx","idx",1053688473),idx,new cljs.core.Keyword(null,"updated-at","updated-at",-1592622336),(new Date()).getTime()], 0));
var G__28702__$1 = ((cljs.core.empty_QMARK_(new cljs.core.Keyword(null,"title","title",636505583).cljs$core$IFn$_invoke$arity$1(scene)))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__28702,new cljs.core.Keyword(null,"title","title",636505583),portfolio.homeless.__GT_title(cljs.core.name(new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(scene)))):G__28702);
var G__28702__$2 = (((new cljs.core.Keyword(null,"collection","collection",-683361892).cljs$core$IFn$_invoke$arity$1(scene) == null))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__28702__$1,new cljs.core.Keyword(null,"collection","collection",-683361892),(function (){var G__28703 = scene;
var G__28703__$1 = (((G__28703 == null))?null:new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(G__28703));
var G__28703__$2 = (((G__28703__$1 == null))?null:cljs.core.namespace(G__28703__$1));
if((G__28703__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__28703__$2);
}
})()):G__28702__$1);
if(cljs.core.truth_(new cljs.core.Keyword(null,"param","param",2013631823).cljs$core$IFn$_invoke$arity$1(scene))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__28702__$2,new cljs.core.Keyword(null,"params","params",710516235),new cljs.core.Keyword(null,"param","param",2013631823).cljs$core$IFn$_invoke$arity$1(scene));
} else {
return G__28702__$2;
}
})());
...
var G__28709 = cljs.core.next(fs);
fs = G__28709;
continue;
} else {
return null;
