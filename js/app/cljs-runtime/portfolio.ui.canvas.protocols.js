...
var portfolio$ui$canvas$protocols$ICanvasToolbarButtonData$prepare_toolbar_button$dyn_30545 = (function (self,state,opt){
...
return portfolio$ui$canvas$protocols$ICanvasToolbarButtonData$prepare_toolbar_button$dyn_30545(self,state,opt);
}
}
});
...
var portfolio$ui$canvas$protocols$ICanvasToolbarButtonView$render_toolbar_button$dyn_30548 = (function (data){
...
return portfolio$ui$canvas$protocols$ICanvasToolbarButtonView$render_toolbar_button$dyn_30548(data);
}
}
});
...
var portfolio$ui$canvas$protocols$ICanvasTool$prepare_canvas$dyn_30554 = (function (self,el,opt){
var x__5393__auto__ = (((self == null))?null:self);
...
return portfolio$ui$canvas$protocols$ICanvasTool$prepare_canvas$dyn_30554(self,el,opt);
}
}
});

var portfolio$ui$canvas$protocols$ICanvasTool$finalize_canvas$dyn_30558 = (function (self,el,opt){
var x__5393__auto__ = (((self == null))?null:self);
...
return portfolio$ui$canvas$protocols$ICanvasTool$finalize_canvas$dyn_30558(self,el,opt);
}
}
});
...
var portfolio$ui$canvas$protocols$ICanvasToolValue$get_tool_value$dyn_30559 = (function (self,state,pane_id){
var x__5393__auto__ = (((self == null))?null:self);
...
return portfolio$ui$canvas$protocols$ICanvasToolValue$get_tool_value$dyn_30559(self,state,pane_id);
}
}
});
...
var portfolio$ui$canvas$protocols$ICanvasToolMiddleware$prepare_view$dyn_30567 = (function (self,f,state,location,view){
var x__5393__auto__ = (((self == null))?null:self);
...
return portfolio$ui$canvas$protocols$ICanvasToolMiddleware$prepare_view$dyn_30567(self,f,state,location,view);
}
}
});
...
var portfolio$ui$canvas$protocols$ICanvasToolPaneMiddleware$prepare_pane$dyn_30572 = (function (self,f,state,view,ctx){
var x__5393__auto__ = (((self == null))?null:self);
...
return portfolio$ui$canvas$protocols$ICanvasToolPaneMiddleware$prepare_pane$dyn_30572(self,f,state,view,ctx);
}
}
});
...
var portfolio$ui$canvas$protocols$ICanvasPanelAddon$prepare_panel_content$dyn_30576 = (function (panel,state,scene){
...
return portfolio$ui$canvas$protocols$ICanvasPanelAddon$prepare_panel_content$dyn_30576(panel,state,scene);
}
}
});
