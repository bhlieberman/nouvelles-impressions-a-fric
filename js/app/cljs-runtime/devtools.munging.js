...
var o15837 = temp__5802__auto__;
var temp__5802__auto____$1 = (o15837["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o15838 = temp__5802__auto____$1;
return (o15838["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__15418__auto__ = f;
return (o__15418__auto__["toString"]).call(o__15418__auto__);
} else {
return "";
}
}catch (e15857){var _ = e15857;
return "";
}});
...
try{var o__15418__auto___16462 = t;
(o__15418__auto___16462["cljs$lang$ctorPrWriter"]).call(o__15418__auto___16462,t,writer);
}catch (e15866){var __16466 = e15866;
}
...
var char_code = (function (){var o__15418__auto__ = (new String(char$));
return (o__15418__auto__["charCodeAt"]).call(o__15418__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__15418__auto__ = String;
return (o__15418__auto__["fromCharCode"]).call(o__15418__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__15898 = num_code;
switch (G__15898) {
case (1):
return (185);
...
var o__15418__auto__ = String;
return (o__15418__auto__["fromCharCode"]).call(o__15418__auto__,superscript_code);
});
/**
...
}catch (e15961){var _e__15459__auto__ = e15961;
return false;
}})())){
...
var vec__15965 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15965,(0),null);
...
var G__16485 = (i__5770__auto___16483 + (1));
i__5770__auto___16483 = G__16485;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__16037){
var vec__16040 = p__16037;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16040,(0),null);
...
var G__16486 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__16487 = cljs.core.butlast(remaining_tokens);
name_tokens = G__16486;
remaining_tokens = G__16487;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq16024){
var G__16025 = cljs.core.first(seq16024);
var seq16024__$1 = cljs.core.next(seq16024);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__16025,seq16024__$1);
}));
...
var vec__16088 = cljs.core.split_with((function (p1__16072_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__16072_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16088,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16088,(1),null);
...
var vec__16117 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16117,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16117,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__16499 = cljs.core.rest(remaining_tokens);
var G__16500 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__16499;
name_tokens = G__16500;
continue;
} else {
...
var vec__16150 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16150,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16150,(1),null);
var vec__16153 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16153,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16153,(1),null);
var vec__16156 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16156,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16156,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16156,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16156,(3),null);
...
var vec__16183 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16183,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16183,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16183,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16183,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16183,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16183,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__16188 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16188,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16188,(1),null);
var vec__16191 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16191,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16191,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__16196 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__16196) : devtools.munging.parse_fn_info_deep.call(null,G__16196));
})()));
}
} else {
return fn_info;
...
var G__16510 = (arity + (1));
var G__16511 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__16245){
var vec__16246 = p__16245;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16246,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16246,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__16258_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__16258_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__16259_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__16259_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__16280){
var vec__16281 = p__16280;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16281,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq16268){
var G__16269 = cljs.core.first(seq16268);
var seq16268__$1 = cljs.core.next(seq16268);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__16269,seq16268__$1);
}));
...
var map__16347 = options;
var map__16347__$1 = cljs.core.__destructure_map(map__16347);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16347__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16347__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16347__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16347__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__16348 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16348,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16348,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16348,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16348,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16348,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16348,(5),null);
...
var o__15418__auto__ = f;
return (o__15418__auto__["getBasis"]).call(o__15418__auto__);
});
/**
...
}catch (e16378){var _e__15459__auto__ = e16378;
...
var G__16528 = (obj[cljs.core.first(path)]);
var G__16529 = cljs.core.rest(path);
obj = G__16528;
path = G__16529;
continue;
} else {
...
var _STAR_ = (function (accum,p__16431){
var vec__16432 = p__16431;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16432,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16432,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__16438){
var vec__16439 = p__16438;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16439,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16439,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16439,(2),null);
...
var post_process = (function (p__16447){
var vec__16448 = p__16447;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16448,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16448,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__16443_SHARP_){
return (obj[cljs.core.first(p1__16443_SHARP_)]);
}),sorted_matches);
