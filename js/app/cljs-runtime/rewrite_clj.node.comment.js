...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k26460,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k26460,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__26532){
var vec__26533 = p__26532;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26533,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26533,(1),null);
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__26459){
var self__ = this;
var G__26459__$1 = this;
return (new cljs.core.RecordIter((0),G__26459__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"s","s",1705939918)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this26461,other26462){
var self__ = this;
var this26461__$1 = this;
return (((!((other26462 == null)))) && ((((this26461__$1.constructor === other26462.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this26461__$1.prefix,other26462.prefix)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this26461__$1.s,other26462.s)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this26461__$1.__extmap,other26462.__extmap)))))))));
}));
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k26460){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k26460);

}
}));

(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__26459){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__26579 = cljs.core.keyword_identical_QMARK_;
var expr__26580 = k__5352__auto__;
...
return (new rewrite_clj.node.comment.CommentNode(G__26459,self__.s,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__26579.cljs$core$IFn$_invoke$arity$2 ? pred__26579.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"s","s",1705939918),expr__26580) : pred__26579.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__26580)))){
return (new rewrite_clj.node.comment.CommentNode(self__.prefix,G__26459,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.comment.CommentNode(self__.prefix,self__.s,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__26459),null));
}
}
}));
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__26459){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.comment.CommentNode(self__.prefix,self__.s,G__26459,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.comment.map__GT_CommentNode = (function rewrite_clj$node$comment$map__GT_CommentNode(G__26465){
var extmap__5385__auto__ = (function (){var G__26626 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__26465,new cljs.core.Keyword(null,"prefix","prefix",-265908465),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"s","s",1705939918)], 0));
if(cljs.core.record_QMARK_(G__26465)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__26626);
} else {
return G__26626;
}
})();
return (new rewrite_clj.node.comment.CommentNode(new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(G__26465),new cljs.core.Keyword(null,"s","s",1705939918).cljs$core$IFn$_invoke$arity$1(G__26465),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
