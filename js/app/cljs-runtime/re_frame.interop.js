...
return [(function (){var pred__23701 = cljs.core.instance_QMARK_;
var expr__23702 = reactive_val;
if(cljs.core.truth_((pred__23701.cljs$core$IFn$_invoke$arity$2 ? pred__23701.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__23702) : pred__23701.call(null,reagent.ratom.RAtom,expr__23702)))){
return "ra";
} else {
if(cljs.core.truth_((pred__23701.cljs$core$IFn$_invoke$arity$2 ? pred__23701.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__23702) : pred__23701.call(null,reagent.ratom.RCursor,expr__23702)))){
return "rc";
} else {
if(cljs.core.truth_((pred__23701.cljs$core$IFn$_invoke$arity$2 ? pred__23701.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__23702) : pred__23701.call(null,reagent.ratom.Reaction,expr__23702)))){
return "rx";
} else {
if(cljs.core.truth_((pred__23701.cljs$core$IFn$_invoke$arity$2 ? pred__23701.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__23702) : pred__23701.call(null,reagent.ratom.Track,expr__23702)))){
return "tr";
} else {
return "other";
}
