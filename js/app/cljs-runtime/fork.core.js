...
fork.core.initialize_state = (function fork$core$initialize_state(p__25998){
var map__25999 = p__25998;
var map__25999__$1 = cljs.core.__destructure_map(map__25999);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25999__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var keywordize_keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25999__$1,new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252));
var initial_values = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25999__$1,new cljs.core.Keyword(null,"initial-values","initial-values",1392120293));
var initial_touched = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25999__$1,new cljs.core.Keyword(null,"initial-touched","initial-touched",-1887894494));
...
var el_name = (function (){var G__26001 = t;
...
fork.core.normalize_name = (function fork$core$normalize_name(k,p__26012){
var map__26013 = p__26012;
var map__26013__$1 = cljs.core.__destructure_map(map__26013);
var keywordize_keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26013__$1,new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252));
...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,(function (p1__26019_SHARP_){
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(cljs.core.update.cljs$core$IFn$_invoke$arity$4(p1__26019_SHARP_,new cljs.core.Keyword(null,"values","values",372645556),cljs.core.merge,new_values),new cljs.core.Keyword(null,"touched","touched",-609134419),(function (x,y){
...
return cljs.core.not_empty(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2((function (p__26020){
var vec__26021 = p__26020;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26021,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26021,(1),null);
...
var len__5769__auto___26130 = arguments.length;
var i__5770__auto___26131 = (0);
while(true){
if((i__5770__auto___26131 < len__5769__auto___26130)){
args__5775__auto__.push((arguments[i__5770__auto___26131]));

var G__26134 = (i__5770__auto___26131 + (1));
i__5770__auto___26131 = G__26134;
continue;
} else {
}
break;
...
(fork.core.disable.cljs$core$IFn$_invoke$arity$variadic = (function (state,p__26052){
var vec__26053 = p__26052;
var ks = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26053,(0),null);
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(state,cljs.core.update,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181),(function (p1__26040_SHARP_){
return fork.core.disable_logic(p1__26040_SHARP_,ks);
}));
}));
...
/** @this {Function} */
(fork.core.disable.cljs$lang$applyTo = (function (seq26045){
var G__26051 = cljs.core.first(seq26045);
var seq26045__$1 = cljs.core.next(seq26045);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26051,seq26045__$1);
}));

fork.core.enable = (function fork$core$enable(var_args){
var args__5775__auto__ = [];
var len__5769__auto___26142 = arguments.length;
var i__5770__auto___26144 = (0);
while(true){
if((i__5770__auto___26144 < len__5769__auto___26142)){
args__5775__auto__.push((arguments[i__5770__auto___26144]));

var G__26145 = (i__5770__auto___26144 + (1));
i__5770__auto___26144 = G__26145;
continue;
} else {
}
break;
...
(fork.core.enable.cljs$core$IFn$_invoke$arity$variadic = (function (state,p__26059){
var vec__26060 = p__26059;
var ks = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26060,(0),null);
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(state,cljs.core.update,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181),(function (p1__26056_SHARP_){
return fork.core.enable_logic(p1__26056_SHARP_,ks);
}));
}));
...
/** @this {Function} */
(fork.core.enable.cljs$lang$applyTo = (function (seq26057){
var G__26058 = cljs.core.first(seq26057);
var seq26057__$1 = cljs.core.next(seq26057);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26058,seq26057__$1);
}));
...
fork.core.set_handle_change_one = (function fork$core$set_handle_change_one(deref_state,p__26063){
var map__26064 = p__26063;
var map__26064__$1 = cljs.core.__destructure_map(map__26064);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26064__$1,new cljs.core.Keyword(null,"value","value",305978217));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26064__$1,new cljs.core.Keyword(null,"path","path",-188191168));
...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,(function (p1__26065_SHARP_){
return fork.core.set_handle_change_one(p1__26065_SHARP_,params);
}));
} else {
...
fork.core.set_handle_blur = (function fork$core$set_handle_blur(p__26066,state){
var map__26067 = p__26066;
var map__26067__$1 = cljs.core.__destructure_map(map__26067);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26067__$1,new cljs.core.Keyword(null,"value","value",305978217));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26067__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var path__$1 = fork.core.vectorize_path(path);
...
var vec__26070 = cljs.core.last(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (p1__26069_SHARP_,p2__26068_SHARP_){
if(typeof p2__26068_SHARP_ === 'number'){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__26069_SHARP_,p2__26068_SHARP_], null);
} else {
return null;
}
}),touched_el)));
var position = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26070,(0),null);
var curr_idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26070,(1),null);
if((curr_idx > idx)){
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update_in.cljs$core$IFn$_invoke$arity$4(s,cljs.core.cons(new cljs.core.Keyword(null,"values","values",372645556),vec_field_array_key),fork.core.vec_remove,idx),new cljs.core.Keyword(null,"touched","touched",-609134419),(function (p1__26073_SHARP_){
return fork.core.fieldarray_update_touched(p1__26073_SHARP_,vec_field_array_key,idx);
}));
}));
});
...
fork.core.handle_submit = (function fork$core$handle_submit(evt,p__26075){
var map__26076 = p__26075;
var map__26076__$1 = cljs.core.__destructure_map(map__26076);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26076__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var server = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26076__$1,new cljs.core.Keyword(null,"server","server",1499190120));
var on_submit = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26076__$1,new cljs.core.Keyword(null,"on-submit","on-submit",1227871159));
var prevent_default_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26076__$1,new cljs.core.Keyword(null,"prevent-default?","prevent-default?",-1165567888));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26076__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var validation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26076__$1,new cljs.core.Keyword(null,"validation","validation",-2141396518));
var already_submitting_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26076__$1,new cljs.core.Keyword(null,"already-submitting?","already-submitting?",1438118407));
var reset = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26076__$1,new cljs.core.Keyword(null,"reset","reset",-800929946));
...
if(((cljs.core.not(already_submitting_QMARK_)) && ((((validation == null)) && ((((fork.core.resolve_server_validation(server) == null)) && (cljs.core.every_QMARK_((function (p1__26074_SHARP_){
return new cljs.core.Keyword(null,"waiting?","waiting?",-2117257215).cljs$core$IFn$_invoke$arity$1(p1__26074_SHARP_) === false;
...
var G__26077 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"state","state",-1988618099),state,new cljs.core.Keyword(null,"path","path",-188191168),path,new cljs.core.Keyword(null,"values","values",372645556),new cljs.core.Keyword(null,"values","values",372645556).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state)),new cljs.core.Keyword(null,"dirty","dirty",729553281),fork.core.dirty(new cljs.core.Keyword(null,"values","values",372645556).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state)),cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"initial-values","initial-values",1392120293).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state)),new cljs.core.Keyword(null,"touched-values","touched-values",-1817885644).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state))], 0))),new cljs.core.Keyword(null,"reset","reset",-800929946),reset], null);
return (on_submit.cljs$core$IFn$_invoke$arity$1 ? on_submit.cljs$core$IFn$_invoke$arity$1(G__26077) : on_submit.call(null,G__26077));
} else {
return null;
}
});
fork.core.send_server_request = (function fork$core$send_server_request(http_fn,p__26078){
var map__26079 = p__26078;
var map__26079__$1 = cljs.core.__destructure_map(map__26079);
var validation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26079__$1,new cljs.core.Keyword(null,"validation","validation",-2141396518));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26079__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var debounce = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26079__$1,new cljs.core.Keyword(null,"debounce","debounce",-871550296));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26079__$1,new cljs.core.Keyword(null,"value","value",305978217));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26079__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var evt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26079__$1,new cljs.core.Keyword(null,"evt","evt",-1251566867));
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26079__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var server_dispatch_logic = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26079__$1,new cljs.core.Keyword(null,"server-dispatch-logic","server-dispatch-logic",-465441551));
var throttle = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26079__$1,new cljs.core.Keyword(null,"throttle","throttle",-1860340776));
var input_key = name;
...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(state,cljs.core.update_in,cljs.core.cons(new cljs.core.Keyword(null,"values","values",372645556),vec_field_array_key),(function (p1__26080_SHARP_){
return fork.core.vec_insert_at(fork.core.vec_remove(p1__26080_SHARP_,dragged_idx),dropped_idx,cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__26080_SHARP_,dragged_idx));
}));
});
fork.core.current_target_idx = (function fork$core$current_target_idx(state,k){
var G__26081 = cljs.core.deref(state);
var G__26081__$1 = (((G__26081 == null))?null:new cljs.core.Keyword(null,"drag-and-drop","drag-and-drop",-1528484051).cljs$core$IFn$_invoke$arity$1(G__26081));
var G__26081__$2 = (((G__26081__$1 == null))?null:(k.cljs$core$IFn$_invoke$arity$1 ? k.cljs$core$IFn$_invoke$arity$1(G__26081__$1) : k.call(null,G__26081__$1)));
if((G__26081__$2 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"idx-of-element-droppable-location","idx-of-element-droppable-location",1338425922).cljs$core$IFn$_invoke$arity$1(G__26081__$2);
}
});
fork.core.current_dragged_idx = (function fork$core$current_dragged_idx(state,k){
var G__26082 = cljs.core.deref(state);
var G__26082__$1 = (((G__26082 == null))?null:new cljs.core.Keyword(null,"drag-and-drop","drag-and-drop",-1528484051).cljs$core$IFn$_invoke$arity$1(G__26082));
var G__26082__$2 = (((G__26082__$1 == null))?null:(k.cljs$core$IFn$_invoke$arity$1 ? k.cljs$core$IFn$_invoke$arity$1(G__26082__$1) : k.call(null,G__26082__$1)));
if((G__26082__$2 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"idx-of-item-being-dragged","idx-of-item-being-dragged",1912676382).cljs$core$IFn$_invoke$arity$1(G__26082__$2);
}
});
...
}),(function (p1__26084_SHARP_){
return fork.core.set_handle_blur(p1__26084_SHARP_,state);
...
}),(function (p1__26083_SHARP_){
return fork.core.set_handle_change(p1__26083_SHARP_,state);
}),(function (k,idx){
...
return (function (p__26085,component){
var map__26086 = p__26085;
var map__26086__$1 = cljs.core.__destructure_map(map__26086);
var args = map__26086__$1;
var props__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26086__$1,new cljs.core.Keyword(null,"props","props",453281727));
