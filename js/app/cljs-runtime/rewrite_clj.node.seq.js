...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k27302,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k27302,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__27331){
var vec__27334 = p__27331;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27334,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27334,(1),null);
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__27300){
var self__ = this;
var G__27300__$1 = this;
return (new cljs.core.RecordIter((0),G__27300__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"format-string","format-string",832187437),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this27303,other27305){
var self__ = this;
var this27303__$1 = this;
return (((!((other27305 == null)))) && ((((this27303__$1.constructor === other27305.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this27303__$1.tag,other27305.tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this27303__$1.format_string,other27305.format_string)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this27303__$1.wrap_length,other27305.wrap_length)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this27303__$1.seq_fn,other27305.seq_fn)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this27303__$1.children,other27305.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this27303__$1.__extmap,other27305.__extmap)))))))))))))));
}));
...
var self__ = this;
var _node__$1 = this;
var G__27359 = rewrite_clj.node.protocols.sexprs.cljs$core$IFn$_invoke$arity$2(self__.children,opts);
return (self__.seq_fn.cljs$core$IFn$_invoke$arity$1 ? self__.seq_fn.cljs$core$IFn$_invoke$arity$1(G__27359) : self__.seq_fn.call(null,G__27359));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k27302){
var self__ = this;
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__27300){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__27378 = cljs.core.keyword_identical_QMARK_;
var expr__27379 = k__5352__auto__;
if(cljs.core.truth_((pred__27378.cljs$core$IFn$_invoke$arity$2 ? pred__27378.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__27379) : pred__27378.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__27379)))){
return (new rewrite_clj.node.seq.SeqNode(G__27300,self__.format_string,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__27378.cljs$core$IFn$_invoke$arity$2 ? pred__27378.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"format-string","format-string",832187437),expr__27379) : pred__27378.call(null,new cljs.core.Keyword(null,"format-string","format-string",832187437),expr__27379)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,G__27300,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__27378.cljs$core$IFn$_invoke$arity$2 ? pred__27378.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__27379) : pred__27378.call(null,new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__27379)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.format_string,G__27300,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__27378.cljs$core$IFn$_invoke$arity$2 ? pred__27378.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__27379) : pred__27378.call(null,new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__27379)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.format_string,self__.wrap_length,G__27300,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__27378.cljs$core$IFn$_invoke$arity$2 ? pred__27378.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__27379) : pred__27378.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__27379)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.format_string,self__.wrap_length,self__.seq_fn,G__27300,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.format_string,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__27300),null));
}
}
}
}
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__27300){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.format_string,self__.wrap_length,self__.seq_fn,self__.children,G__27300,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.seq.map__GT_SeqNode = (function rewrite_clj$node$seq$map__GT_SeqNode(G__27307){
var extmap__5385__auto__ = (function (){var G__27400 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__27307,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"format-string","format-string",832187437),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
...
return (new rewrite_clj.node.seq.SeqNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__27307),new cljs.core.Keyword(null,"format-string","format-string",832187437).cljs$core$IFn$_invoke$arity$1(G__27307),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519).cljs$core$IFn$_invoke$arity$1(G__27307),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231).cljs$core$IFn$_invoke$arity$1(G__27307),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__27307),null,cljs.core.not_empty(extmap__5385__auto__),null));
});

rewrite_clj.node.protocols.make_printable_BANG_(rewrite_clj.node.seq.SeqNode);
var list_node_seq_fn_27424 = (function (p1__27402_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,p1__27402_SHARP_);
});
/**
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"list","list",765357683),"(%s)",(2),list_node_seq_fn_27424,children);
});
/**
...
var map_seq_fn_27427 = (function (p1__27409_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,p1__27409_SHARP_);
});
/**
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"map","map",1371690461),"{%s}",(2),map_seq_fn_27427,children);
});
