...
var alandipert$storage_atom$IStorageBackend$_get$dyn_26944 = (function (this$,not_found){
var x__5393__auto__ = (((this$ == null))?null:this$);
var m__5394__auto__ = (alandipert.storage_atom._get[goog.typeOf(x__5393__auto__)]);
if((!((m__5394__auto__ == null)))){
return (m__5394__auto__.cljs$core$IFn$_invoke$arity$2 ? m__5394__auto__.cljs$core$IFn$_invoke$arity$2(this$,not_found) : m__5394__auto__.call(null,this$,not_found));
} else {
var m__5392__auto__ = (alandipert.storage_atom._get["_"]);
if((!((m__5392__auto__ == null)))){
return (m__5392__auto__.cljs$core$IFn$_invoke$arity$2 ? m__5392__auto__.cljs$core$IFn$_invoke$arity$2(this$,not_found) : m__5392__auto__.call(null,this$,not_found));
} else {
...
return alandipert$storage_atom$IStorageBackend$_get$dyn_26944(this$,not_found);
}
});

var alandipert$storage_atom$IStorageBackend$_commit_BANG_$dyn_26945 = (function (this$,value){
var x__5393__auto__ = (((this$ == null))?null:this$);
var m__5394__auto__ = (alandipert.storage_atom._commit_BANG_[goog.typeOf(x__5393__auto__)]);
if((!((m__5394__auto__ == null)))){
...
var m__5392__auto__ = (alandipert.storage_atom._commit_BANG_["_"]);
if((!((m__5392__auto__ == null)))){
...
return alandipert$storage_atom$IStorageBackend$_commit_BANG_$dyn_26945(this$,value);
}
});
...
var self__ = this;
var this$__$1 = this;
var temp__5802__auto__ = self__.store.getItem(alandipert.storage_atom.clj__GT_json(self__.key));
...
(alandipert.storage_atom.StorageBackend.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"alandipert.storage-atom/StorageBackend");
}));
...
var G__26937 = atom;
cljs.core.add_watch(G__26937,new cljs.core.Keyword("alandipert.storage-atom","storage-watch","alandipert.storage-atom/storage-watch",1159565749),(function (p1__26935_SHARP_,p2__26936_SHARP_,p3__26933_SHARP_,p4__26934_SHARP_){
if(cljs.core.truth_((function (){var and__5043__auto__ = alandipert.storage_atom._STAR_watch_active_STAR_;
if(cljs.core.truth_(and__5043__auto__)){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p3__26933_SHARP_,p4__26934_SHARP_);
} else {
return and__5043__auto__;
}
})())){
return debounce((function (){
return alandipert.storage_atom._commit_BANG_(backend,p4__26934_SHARP_);
}),(function (){var or__5045__auto__ = alandipert.storage_atom._STAR_storage_delay_STAR_;
...
var _STAR_watch_active_STAR__orig_val__26938 = alandipert.storage_atom._STAR_watch_active_STAR_;
var _STAR_watch_active_STAR__temp_val__26939 = false;
(alandipert.storage_atom._STAR_watch_active_STAR_ = _STAR_watch_active_STAR__temp_val__26939);

try{return cljs.core.reset_BANG_(atom,default$);
}finally {(alandipert.storage_atom._STAR_watch_active_STAR_ = _STAR_watch_active_STAR__orig_val__26938);
}} else {
try{var temp__5804__auto__ = alandipert.storage_atom.json__GT_clj(e.key);
if(cljs.core.truth_(temp__5804__auto__)){
var sk = temp__5804__auto__;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(sk,k)){
var _STAR_watch_active_STAR__orig_val__26941 = alandipert.storage_atom._STAR_watch_active_STAR_;
var _STAR_watch_active_STAR__temp_val__26942 = false;
(alandipert.storage_atom._STAR_watch_active_STAR_ = _STAR_watch_active_STAR__temp_val__26942);
...
}finally {(alandipert.storage_atom._STAR_watch_active_STAR_ = _STAR_watch_active_STAR__orig_val__26941);
}} else {
return null;
}
} else {
...
return window.addEventListener("storage",(function (p1__26943_SHARP_){
return alandipert.storage_atom.maybe_update_backend(atom,storage,k,default$,p1__26943_SHARP_);
}));
});
/**
