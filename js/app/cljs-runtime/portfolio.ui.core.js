...
portfolio.ui.core.sidebar_QMARK_ = (function portfolio$ui$core$sidebar_QMARK_(p__32539){
var map__32540 = p__32539;
var map__32540__$1 = cljs.core.__destructure_map(map__32540);
var state = map__32540__$1;
var sidebar_status = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32540__$1,new cljs.core.Keyword(null,"sidebar-status","sidebar-status",922425311));
...
(portfolio.ui.core.prepare_scene_browser.cljs$core$IFn$_invoke$arity$variadic = (function (state,location,p__32546){
var vec__32547 = p__32546;
var map__32550 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32547,(0),null);
var map__32550__$1 = cljs.core.__destructure_map(map__32550);
var select_actions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32550__$1,new cljs.core.Keyword(null,"select-actions","select-actions",-859150860));
...
/** @this {Function} */
(portfolio.ui.core.prepare_scene_browser.cljs$lang$applyTo = (function (seq32543){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32544,G__32545,seq32543__$2);
}));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__32567,new cljs.core.Keyword(null,"selected?","selected?",-742502788),true);
} else {
return G__32567;
}
});
...
var G__32574 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"small?","small?",95242445),portfolio.ui.screen.small_screen_QMARK_(state__$1),new cljs.core.Keyword(null,"tab-bar","tab-bar",-787971209),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tabs","tabs",-779855354),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32572_SHARP_){
return portfolio.ui.core.prepare_view_option(current_view,p1__32572_SHARP_);
...
if(scenes_QMARK_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(G__32574,new cljs.core.Keyword(null,"header","header",119441134),portfolio.ui.core.prepare_header(state__$1,location),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"sidebar","sidebar",35784458),portfolio.ui.core.prepare_sidebar(state__$1,location)], 0));
} else {
return G__32574;
}
});
