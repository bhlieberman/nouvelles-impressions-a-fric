...
var len__5769__auto___29847 = arguments.length;
var i__5770__auto___29848 = (0);
while(true){
if((i__5770__auto___29848 < len__5769__auto___29847)){
args__5775__auto__.push((arguments[i__5770__auto___29848]));

var G__29849 = (i__5770__auto___29848 + (1));
i__5770__auto___29848 = G__29849;
continue;
} else {
}
break;
...
/** @this {Function} */
(markdown.common.freeze_string.cljs$lang$applyTo = (function (seq29714){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq29714));
}));
...
var G__29863 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (text,state,matches,temp__5802__auto__){
return (function (s,r){
...
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560).cljs$core$IFn$_invoke$arity$1(state),p1__29725_SHARP_,p1__29725_SHARP_);
});})(text,state,matches,temp__5802__auto__))
);
});})(text,state,matches,temp__5802__auto__))
,text,matches);
var G__29864 = cljs.core.update.cljs$core$IFn$_invoke$arity$3(state,new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560),((function (text,state,matches,temp__5802__auto__){
return (function (p1__29726_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc,p1__29726_SHARP_,matches);
});})(text,state,matches,temp__5802__auto__))
);
text = G__29863;
state = G__29864;
...
var vec__29780 = (((transformer === cljs.core.identity))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [buf,cur_state], null):(function (){var vec__29784 = (function (){var G__29789 = clojure.string.join.cljs$core$IFn$_invoke$arity$1(buf);
var G__29790 = cur_state;
return (transformer.cljs$core$IFn$_invoke$arity$2 ? transformer.cljs$core$IFn$_invoke$arity$2(G__29789,G__29790) : transformer.call(null,G__29789,G__29790));
})();
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29784,(0),null);
var new_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29784,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.seq(s),new_state], null);
})());
var new_buf = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29780,(0),null);
var new_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29780,(1),null);
var G__29906 = cljs.core.vec(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(out,cljs.core.seq(open),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new_buf,cljs.core.seq(close)], 0)));
var G__29907 = cljs.core.PersistentVector.EMPTY;
var G__29908 = cljs.core.rest(tokens);
var G__29909 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(new_state,new cljs.core.Keyword(null,"found-token","found-token",113525576),false);
out = G__29906;
buf = G__29907;
tokens = G__29908;
cur_state = G__29909;
...
var G__29910 = out;
var G__29911 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(buf,cljs.core.first(tokens));
var G__29912 = cljs.core.rest(tokens);
var G__29913 = cur_state;
out = G__29910;
buf = G__29911;
tokens = G__29912;
cur_state = G__29913;
...
var G__29917 = out;
var G__29918 = buf;
var G__29919 = cljs.core.rest(tokens);
var G__29920 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cur_state,new cljs.core.Keyword(null,"found-token","found-token",113525576),true);
out = G__29917;
buf = G__29918;
tokens = G__29919;
cur_state = G__29920;
...
var G__29921 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(out,cljs.core.first(tokens));
var G__29922 = buf;
var G__29923 = cljs.core.rest(tokens);
var G__29924 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cur_state,new cljs.core.Keyword(null,"in-tag?","in-tag?",1693672911),markdown.common.open_html_tags(new cljs.core.Keyword(null,"in-tag?","in-tag?",1693672911).cljs$core$IFn$_invoke$arity$1(cur_state),cljs.core.first(tokens)));
out = G__29921;
buf = G__29922;
tokens = G__29923;
cur_state = G__29924;
...
var num_hashes = cljs.core.count(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__29816_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(" ",p1__29816_SHARP_);
}),cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__29817_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",p1__29817_SHARP_)) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(" ",p1__29817_SHARP_)));
}),cljs.core.seq(text))));
if((num_hashes > (0))){
return num_hashes;
} else {
