...
var G__47678 = request;
var G__47679 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__47678,G__47679) : ajax.formats.get_format.call(null,G__47678,G__47679));
} else {
...
return cljs.core.some((function (p1__47691_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__47691_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__47692){
var map__47693 = p__47692;
var map__47693__$1 = cljs.core.__destructure_map(map__47693);
var request = map__47693__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47693__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__47699 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__47699.cljs$core$IFn$_invoke$arity$1 ? fexpr__47699.cljs$core$IFn$_invoke$arity$1(response) : fexpr__47699.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__47701){
var map__47702 = p__47701;
var map__47702__$1 = cljs.core.__destructure_map(map__47702);
var request = map__47702__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47702__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__47700_SHARP_){
return ajax.formats.get_accept_entries(request,p1__47700_SHARP_);
