...
var sym_seq = (function (){var iter__5523__auto__ = (function rewrite_clj$node$fn$fn_walk_$_iter__26466(s__26467){
return (new cljs.core.LazySeq(null,(function (){
var s__26467__$1 = s__26467;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__26467__$1);
if(temp__5804__auto__){
var s__26467__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__26467__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__26467__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__26469 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__26468 = (0);
while(true){
if((i__26468 < size__5522__auto__)){
var i = cljs.core._nth(c__5521__auto__,i__26468);
...
cljs.core.chunk_append(b__26469,cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')));

var G__26573 = (i__26468 + (1));
i__26468 = G__26573;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__26469),rewrite_clj$node$fn$fn_walk_$_iter__26466(cljs.core.chunk_rest(s__26467__$2)));
} else {
...
var base = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,(0)))?"rest__":["p",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i),"__"].join(''));
var s = cljs.core.name(cljs.core.gensym.cljs$core$IFn$_invoke$arity$1(base));
return cljs.core.cons(cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')),rewrite_clj$node$fn$fn_walk_$_iter__26466(cljs.core.rest(s__26467__$2)));
}
} else {
return null;
}
...
var body = clojure.walk.prewalk((function (p1__26463_SHARP_){
var or__5045__auto__ = rewrite_clj.node.fn.arg_symbol__GT_gensym(sym_seq,vararg_QMARK_,max_fixed_arg_ndx,p1__26463_SHARP_);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k26485,else__5346__auto__){
var self__ = this;
var this__5345__auto____$1 = this;
var G__26509 = k26485;
var G__26509__$1 = (((G__26509 instanceof cljs.core.Keyword))?G__26509.fqn:null);
switch (G__26509__$1) {
case "children":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k26485,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__26513){
var vec__26514 = p__26513;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26514,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26514,(1),null);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__26484){
var self__ = this;
var G__26484__$1 = this;
return (new cljs.core.RecordIter((0),G__26484__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this26486,other26487){
var self__ = this;
var this26486__$1 = this;
return (((!((other26487 == null)))) && ((((this26486__$1.constructor === other26487.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this26486__$1.children,other26487.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this26486__$1.__extmap,other26487.__extmap)))))));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k26485){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k26485);

}
}));

(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__26484){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__26551 = cljs.core.keyword_identical_QMARK_;
var expr__26552 = k__5352__auto__;
if(cljs.core.truth_((pred__26551.cljs$core$IFn$_invoke$arity$2 ? pred__26551.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__26552) : pred__26551.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__26552)))){
return (new rewrite_clj.node.fn.FnNode(G__26484,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.fn.FnNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__26484),null));
}
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__26484){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.fn.FnNode(self__.children,G__26484,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.fn.map__GT_FnNode = (function rewrite_clj$node$fn$map__GT_FnNode(G__26497){
var extmap__5385__auto__ = (function (){var G__26562 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__26497,new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.record_QMARK_(G__26497)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__26562);
} else {
return G__26562;
}
})();
return (new rewrite_clj.node.fn.FnNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__26497),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
