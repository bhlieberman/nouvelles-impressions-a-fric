...
var args__$1 = args.map((function (p1__32768_SHARP_){
return sci.impl.types.eval(p1__32768_SHARP_,ctx,bindings);
}));
...
return Reflect.construct(constructor$,args.map((function (p1__32825_SHARP_){
return sci.impl.types.eval(p1__32825_SHARP_,ctx,bindings);
})));
});
sci.impl.interop.invoke_static_method = (function sci$impl$interop$invoke_static_method(ctx,bindings,class$,method,args){
return Reflect.apply(method,class$,args.map((function (p1__32835_SHARP_){
return sci.impl.types.eval(p1__32835_SHARP_,ctx,bindings);
})));
});
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__32878 = temp__5802__auto__;
