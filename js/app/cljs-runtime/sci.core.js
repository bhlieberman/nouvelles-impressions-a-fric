...
var G__41183 = sci.core.new_var.cljs$core$IFn$_invoke$arity$3(name,null,null);
sci.impl.vars.unbind(G__41183);
...
var G__41186 = sci.core.new_dynamic_var.cljs$core$IFn$_invoke$arity$3(name,null,null);
sci.impl.vars.unbind(G__41186);
...
var new_m = (function (){var G__41195 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ns","ns",441598760),sci_ns,new cljs.core.Keyword(null,"name","name",1843675177),nm], null);
var G__41195__$1 = (cljs.core.truth_(macro)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__41195,new cljs.core.Keyword(null,"macro","macro",-867863404),true):G__41195);
var G__41195__$2 = (cljs.core.truth_(doc)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__41195__$1,new cljs.core.Keyword(null,"doc","doc",1913296891),doc):G__41195__$1);
var G__41195__$3 = (cljs.core.truth_(arglists)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__41195__$2,new cljs.core.Keyword(null,"arglists","arglists",1661989754),arglists):G__41195__$2);
if(cljs.core.truth_(dynamic)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__41195__$3,new cljs.core.Keyword(null,"dynamic","dynamic",704819571),dynamic);
} else {
return G__41195__$3;
}
})();
...
var len__5769__auto___41260 = arguments.length;
var i__5770__auto___41261 = (0);
while(true){
if((i__5770__auto___41261 < len__5769__auto___41260)){
args_arr__5794__auto__.push((arguments[i__5770__auto___41261]));

var G__41262 = (i__5770__auto___41261 + (1));
i__5770__auto___41261 = G__41262;
continue;
} else {
}
break;
...
var _STAR_unrestricted_STAR__orig_val__41209 = sci.impl.unrestrict._STAR_unrestricted_STAR_;
var _STAR_unrestricted_STAR__temp_val__41210 = true;
(sci.impl.unrestrict._STAR_unrestricted_STAR_ = _STAR_unrestricted_STAR__temp_val__41210);

try{return sci.impl.vars.alter_var_root.cljs$core$IFn$_invoke$arity$2(v,f);
}finally {(sci.impl.unrestrict._STAR_unrestricted_STAR_ = _STAR_unrestricted_STAR__orig_val__41209);
}}));

(sci.core.alter_var_root.cljs$core$IFn$_invoke$arity$variadic = (function (v,f,args){
var _STAR_unrestricted_STAR__orig_val__41211 = sci.impl.unrestrict._STAR_unrestricted_STAR_;
var _STAR_unrestricted_STAR__temp_val__41212 = true;
(sci.impl.unrestrict._STAR_unrestricted_STAR_ = _STAR_unrestricted_STAR__temp_val__41212);

try{return cljs.core.apply.cljs$core$IFn$_invoke$arity$4(sci.impl.vars.alter_var_root,v,f,args);
}finally {(sci.impl.unrestrict._STAR_unrestricted_STAR_ = _STAR_unrestricted_STAR__orig_val__41211);
}}));

/** @this {Function} */
(sci.core.alter_var_root.cljs$lang$applyTo = (function (seq41205){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41206,G__41207,seq41205__$2);
}));
...
var G__41237 = ex;
var G__41237__$1 = (((G__41237 == null))?null:cljs.core.ex_data(G__41237));
var G__41237__$2 = (((G__41237__$1 == null))?null:new cljs.core.Keyword("sci.impl","callstack","sci.impl/callstack",-1621010557).cljs$core$IFn$_invoke$arity$1(G__41237__$1));
if((G__41237__$2 == null)){
return null;
} else {
return sci.impl.callstack.stacktrace(G__41237__$2);
}
});
/**
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ns_map,p__41238){
var vec__41239 = p__41238;
var var_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41239,(0),null);
var var$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41239,(1),null);
...
sci.core.process_publics = (function sci$core$process_publics(publics,p__41244){
var map__41245 = p__41244;
var map__41245__$1 = cljs.core.__destructure_map(map__41245);
var exclude = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41245__$1,new cljs.core.Keyword(null,"exclude","exclude",-1230250334));
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ns_map,p__41246){
var vec__41247 = p__41246;
var var_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41247,(0),null);
var var$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41247,(1),null);
...
var G__41253 = ctx;
var G__41254 = cljs.core.PersistentArrayMap.EMPTY;
var G__41255 = sym;
var fexpr__41252 = cljs.core.deref(sci.impl.utils.eval_resolve_state);
return (fexpr__41252.cljs$core$IFn$_invoke$arity$3 ? fexpr__41252.cljs$core$IFn$_invoke$arity$3(G__41253,G__41254,G__41255) : fexpr__41252.call(null,G__41253,G__41254,G__41255));
});
/**
