...
var G__23010 = o;
reagent.impl.template.goog$module$goog$object.set(G__23010,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__23014 = o;
reagent.impl.template.goog$module$goog$object.set(G__23014,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__23107__i < G__23107__a.length) {G__23107__a[G__23107__i] = arguments[G__23107__i + 0]; ++G__23107__i;}
  args = new cljs.core.IndexedSeq(G__23107__a,0,null);
} 
...
var G__23018 = props;
var G__23018__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23018,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__23018);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23018__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__23019 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23019,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__23019;
}
})(),id_class);
...
var G__23020 = (cljs.core.count(argv) - first_child);
switch (G__23020) {
case (0):
...
var vec__23021 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23021,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23021,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23021,(2),null);
...
var temp__5808__auto___23122 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___23122 == null)){
} else {
var key_23123 = temp__5808__auto___23122;
(jsprops.key = key_23123);
}
...
var temp__5808__auto___23128 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___23128 == null)){
} else {
var key_23129 = temp__5808__auto___23128;
(jsprops.key = key_23129);
}
...
var temp__5808__auto___23138 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___23138 == null)){
} else {
var key_23139 = temp__5808__auto___23138;
(jsprops.key = key_23139);
}
...
var temp__5808__auto___23146 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___23146 == null)){
} else {
var key_23147 = temp__5808__auto___23146;
(jsprops.key = key_23147);
}
...
var temp__5808__auto___23151 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___23151 == null)){
} else {
var key_23152 = temp__5808__auto___23151;
(jsprops.key = key_23152);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__23044_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__23044_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__23045 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23045,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23045,(1),null);
...
break;
default:
var G__23167 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__23168 = compiler;
v = G__23167;
compiler = G__23168;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template23071 = (function (opts,id,fn_to_element,parse_fn,meta23072){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template23071.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_23073,meta23072__$1){
var self__ = this;
var _23073__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template23071(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta23072__$1));
}));

(reagent.impl.template.t_reagent$impl$template23071.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_23073){
var self__ = this;
var _23073__$1 = this;
return self__.meta23072;
}));

(reagent.impl.template.t_reagent$impl$template23071.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template23071.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template23071.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template23071.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template23071.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template23071.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta23072","meta23072",-26779547,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template23071.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template23071.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template23071");

(reagent.impl.template.t_reagent$impl$template23071.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template23071");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template23071.
 */
reagent.impl.template.__GT_t_reagent$impl$template23071 = (function reagent$impl$template$__GT_t_reagent$impl$template23071(opts,id,fn_to_element,parse_fn,meta23072){
return (new reagent.impl.template.t_reagent$impl$template23071(opts,id,fn_to_element,parse_fn,meta23072));
});
...
return (new reagent.impl.template.t_reagent$impl$template23071(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
