...
var G__16523 = devtools.prefs.pref(v);
v = G__16523;
continue;
} else {
return v;
...
}catch (e16489){var _e__15459__auto__ = e16489;
return false;
}})();
...
}catch (e16496){var _e__15459__auto__ = e16496;
return false;
}})();
...
}catch (e16502){var _e__15459__auto__ = e16502;
return false;
}}
}
});
...
var vec__16507 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16507,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16507,(1),null);
...
return cljs.core.some((function (p1__16512_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__16512_SHARP_);
}),template);
});
