...
(rewrite_clj.node.integer.IntNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k26605,else__5346__auto__){
var self__ = this;
var this__5345__auto____$1 = this;
var G__26620 = k26605;
var G__26620__$1 = (((G__26620 instanceof cljs.core.Keyword))?G__26620.fqn:null);
switch (G__26620__$1) {
case "value":
return self__.value;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k26605,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__26622){
var vec__26623 = p__26622;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26623,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26623,(1),null);
...
(rewrite_clj.node.integer.IntNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__26604){
var self__ = this;
var G__26604__$1 = this;
return (new cljs.core.RecordIter((0),G__26604__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"value","value",305978217),new cljs.core.Keyword(null,"base","base",185279322)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.integer.IntNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this26606,other26607){
var self__ = this;
var this26606__$1 = this;
return (((!((other26607 == null)))) && ((((this26606__$1.constructor === other26607.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this26606__$1.value,other26607.value)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this26606__$1.base,other26607.base)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this26606__$1.__extmap,other26607.__extmap)))))))));
}));
...
var abs_value = (function (){var G__26689 = self__.value;
if((self__.value < (0))){
return (- G__26689);
} else {
return G__26689;
...
var prefix = (function (){var G__26693 = cljs.core.long$(self__.base);
switch (G__26693) {
case (8):
return "0";
...
(rewrite_clj.node.integer.IntNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k26605){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k26605);

}
}));

(rewrite_clj.node.integer.IntNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__26604){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__26704 = cljs.core.keyword_identical_QMARK_;
var expr__26705 = k__5352__auto__;
if(cljs.core.truth_((pred__26704.cljs$core$IFn$_invoke$arity$2 ? pred__26704.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"value","value",305978217),expr__26705) : pred__26704.call(null,new cljs.core.Keyword(null,"value","value",305978217),expr__26705)))){
return (new rewrite_clj.node.integer.IntNode(G__26604,self__.base,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__26704.cljs$core$IFn$_invoke$arity$2 ? pred__26704.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"base","base",185279322),expr__26705) : pred__26704.call(null,new cljs.core.Keyword(null,"base","base",185279322),expr__26705)))){
return (new rewrite_clj.node.integer.IntNode(self__.value,G__26604,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.integer.IntNode(self__.value,self__.base,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__26604),null));
}
}
}));
...
(rewrite_clj.node.integer.IntNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__26604){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.integer.IntNode(self__.value,self__.base,G__26604,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.integer.map__GT_IntNode = (function rewrite_clj$node$integer$map__GT_IntNode(G__26609){
var extmap__5385__auto__ = (function (){var G__26733 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__26609,new cljs.core.Keyword(null,"value","value",305978217),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"base","base",185279322)], 0));
...
return (new rewrite_clj.node.integer.IntNode(new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(G__26609),new cljs.core.Keyword(null,"base","base",185279322).cljs$core$IFn$_invoke$arity$1(G__26609),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
