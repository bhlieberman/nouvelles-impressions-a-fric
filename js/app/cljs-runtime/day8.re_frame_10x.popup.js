...
var map__27123 = cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v3v0.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.app-db.subs","popup-menu","day8.re-frame-10x.panels.app-db.subs/popup-menu",-100095659)], null)));
var map__27123__$1 = cljs.core.__destructure_map(map__27123);
var vec__27124 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27123__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var left = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27124,(0),null);
var top = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27124,(1),null);
var showing_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27123__$1,new cljs.core.Keyword(null,"showing?","showing?",2094921488));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27123__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27123__$1,new cljs.core.Keyword(null,"data","data",-232669377));
var data_path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27123__$1,new cljs.core.Keyword(null,"data-path","data-path",674802181));
...
var G__27128_27139 = data_path;
if((G__27128_27139 == null)){
} else {
day8.re_frame_10x.fx.clipboard.copy_BANG_(G__27128_27139);
}
...
var G__27129_27142 = data;
var G__27129_27143__$1 = (((G__27129_27142 == null))?null:cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(G__27129_27142,cljs.core.drop.cljs$core$IFn$_invoke$arity$2(cljs.core.count(path),cljs.core.pop(data_path))));
if((G__27129_27143__$1 == null)){
} else {
day8.re_frame_10x.fx.clipboard.copy_BANG_(G__27129_27143__$1);
}
