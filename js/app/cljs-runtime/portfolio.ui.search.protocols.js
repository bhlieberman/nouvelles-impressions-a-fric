...
var portfolio$ui$search$protocols$Index$index$dyn_30493 = (function (self,document){
...
return portfolio$ui$search$protocols$Index$index$dyn_30493(self,document);
}
});

var portfolio$ui$search$protocols$Index$query$dyn_30495 = (function (self,q){
var x__5393__auto__ = (((self == null))?null:self);
...
return portfolio$ui$search$protocols$Index$query$dyn_30495(self,q);
}
});
...
var portfolio$ui$search$protocols$SearchResult$prepare_result$dyn_30497 = (function (self,state,location,result){
var x__5393__auto__ = (((self == null))?null:self);
...
return portfolio$ui$search$protocols$SearchResult$prepare_result$dyn_30497(self,state,location,result);
}
});
