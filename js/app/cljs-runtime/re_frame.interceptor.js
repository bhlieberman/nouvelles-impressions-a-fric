...
var G__24201 = (i__5770__auto___24199 + (1));
i__5770__auto___24199 = G__24201;
continue;
} else {
}
break;
...
(re_frame.interceptor.__GT_interceptor.cljs$core$IFn$_invoke$arity$variadic = (function (p__24058){
var map__24059 = p__24058;
var map__24059__$1 = cljs.core.__destructure_map(map__24059);
var m = map__24059__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24059__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var comment = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24059__$1,new cljs.core.Keyword(null,"comment","comment",532206069));
var before = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24059__$1,new cljs.core.Keyword(null,"before","before",-1633692388));
var after = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24059__$1,new cljs.core.Keyword(null,"after","after",594996914));
if(re_frame.interop.debug_enabled_QMARK_){
var temp__5802__auto___24203 = cljs.core.seq(clojure.set.difference.cljs$core$IFn$_invoke$arity$variadic(cljs.core.set(cljs.core.keys(m)),re_frame.interceptor.mandatory_interceptor_keys,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([re_frame.interceptor.optional_interceptor_keys], 0)));
if(temp__5802__auto___24203){
var unknown_keys_24204 = temp__5802__auto___24203;
re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["re-frame: ->interceptor",m,"has unknown keys:",unknown_keys_24204], 0));
} else {
}
} else {
}

var G__24063 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),(function (){var or__5045__auto__ = id;
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__24063,new cljs.core.Keyword(null,"comment","comment",532206069),comment);
} else {
return G__24063;
}
}));
...
/** @this {Function} */
(re_frame.interceptor.__GT_interceptor.cljs$lang$applyTo = (function (seq24050){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq24050));
}));
...
var args__5775__auto__ = [];
var len__5769__auto___24213 = arguments.length;
var i__5770__auto___24214 = (0);
while(true){
if((i__5770__auto___24214 < len__5769__auto___24213)){
args__5775__auto__.push((arguments[i__5770__auto___24214]));

var G__24215 = (i__5770__auto___24214 + (1));
i__5770__auto___24214 = G__24215;
continue;
} else {
}
break;
...
/** @this {Function} */
(re_frame.interceptor.update_effect.cljs$lang$applyTo = (function (seq24088){
var G__24089 = cljs.core.first(seq24088);
var seq24088__$1 = cljs.core.next(seq24088);
var G__24090 = cljs.core.first(seq24088__$1);
var seq24088__$2 = cljs.core.next(seq24088__$1);
var G__24091 = cljs.core.first(seq24088__$2);
var seq24088__$3 = cljs.core.next(seq24088__$2);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24089,G__24090,G__24091,seq24088__$3);
}));
...
var args__5775__auto__ = [];
var len__5769__auto___24224 = arguments.length;
var i__5770__auto___24225 = (0);
while(true){
if((i__5770__auto___24225 < len__5769__auto___24224)){
args__5775__auto__.push((arguments[i__5770__auto___24225]));

var G__24226 = (i__5770__auto___24225 + (1));
i__5770__auto___24225 = G__24226;
continue;
} else {
}
break;
...
/** @this {Function} */
(re_frame.interceptor.update_coeffect.cljs$lang$applyTo = (function (seq24103){
var G__24104 = cljs.core.first(seq24103);
var seq24103__$1 = cljs.core.next(seq24103);
var G__24105 = cljs.core.first(seq24103__$1);
var seq24103__$2 = cljs.core.next(seq24103__$1);
var G__24106 = cljs.core.first(seq24103__$2);
var seq24103__$3 = cljs.core.next(seq24103__$2);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24104,G__24105,G__24106,seq24103__$3);
}));
...
re_frame.interceptor.invoke_interceptor_fn = (function re_frame$interceptor$invoke_interceptor_fn(p__24119,interceptor,direction){
var map__24123 = p__24119;
var map__24123__$1 = cljs.core.__destructure_map(map__24123);
var context = map__24123__$1;
var augment_exceptions_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24123__$1,new cljs.core.Keyword("re-frame.interceptor","augment-exceptions?","re-frame.interceptor/augment-exceptions?",26769675));
var f = cljs.core.get.cljs$core$IFn$_invoke$arity$2(interceptor,direction);
if(cljs.core.not(f)){
return context;
} else {
if(cljs.core.not(augment_exceptions_QMARK_)){
...
var args__5775__auto__ = [];
var len__5769__auto___24241 = arguments.length;
var i__5770__auto___24243 = (0);
while(true){
if((i__5770__auto___24243 < len__5769__auto___24241)){
args__5775__auto__.push((arguments[i__5770__auto___24243]));

var G__24245 = (i__5770__auto___24243 + (1));
i__5770__auto___24243 = G__24245;
continue;
} else {
}
break;
...
/** @this {Function} */
(re_frame.interceptor.merge_ex_data.cljs$lang$applyTo = (function (seq24158){
...
var new_trace__23841__auto___24248 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.update.cljs$core$IFn$_invoke$arity$4(re_frame.trace._STAR_current_trace_STAR_,new cljs.core.Keyword(null,"tags","tags",1771418977),cljs.core.merge,new cljs.core.Keyword(null,"tags","tags",1771418977).cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tags","tags",1771418977),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"interceptors","interceptors",-1546782951),interceptors], null)], null))),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tags","tags",1771418977),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"interceptors","interceptors",-1546782951),interceptors], null)], null),new cljs.core.Keyword(null,"tags","tags",1771418977))], 0));
(re_frame.trace._STAR_current_trace_STAR_ = new_trace__23841__auto___24248);

} else {
}

if(cljs.core.not(error_handler)){
return re_frame.interceptor.execute_STAR_(ctx);
} else {
try{return re_frame.interceptor.execute_STAR_(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ctx,new cljs.core.Keyword("re-frame.interceptor","augment-exceptions?","re-frame.interceptor/augment-exceptions?",26769675),true));
}catch (e24168){var e = e24168;
var G__24169 = cljs.core.ex_cause(e);
var G__24170 = re_frame.interceptor.merge_ex_data.cljs$core$IFn$_invoke$arity$variadic(e,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"event-v","event-v",1378681365),event_v], null)], 0));
return (error_handler.cljs$core$IFn$_invoke$arity$2 ? error_handler.cljs$core$IFn$_invoke$arity$2(G__24169,G__24170) : error_handler.call(null,G__24169,G__24170));
}}
});
