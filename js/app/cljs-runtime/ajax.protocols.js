...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_46000 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_46000(this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_46001 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_46001(this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_46005 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_46005(this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_46006 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_46006(this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_46007 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_46007(this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_46008 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_46008(this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_46009 = (function (this$,header){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_46009(this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_46010 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_46010(this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_46014 = (function (this$,request){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_46014(this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_46015 = (function (this$,response){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_46015(this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k45878,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k45878,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__45932){
var vec__45933 = p__45932;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45933,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45933,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__45877){
var self__ = this;
var G__45877__$1 = this;
return (new cljs.core.RecordIter((0),G__45877__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this45879,other45880){
var self__ = this;
var this45879__$1 = this;
return (((!((other45880 == null)))) && ((((this45879__$1.constructor === other45880.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45879__$1.status,other45880.status)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45879__$1.body,other45880.body)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45879__$1.status_text,other45880.status_text)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45879__$1.headers,other45880.headers)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45879__$1.was_aborted,other45880.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45879__$1.__extmap,other45880.__extmap)))))))))))))));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k45878){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k45878);

}
}));

(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__45877){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__45994 = cljs.core.keyword_identical_QMARK_;
var expr__45995 = k__5352__auto__;
if(cljs.core.truth_((pred__45994.cljs$core$IFn$_invoke$arity$2 ? pred__45994.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status","status",-1997798413),expr__45995) : pred__45994.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__45995)))){
return (new ajax.protocols.Response(G__45877,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__45994.cljs$core$IFn$_invoke$arity$2 ? pred__45994.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"body","body",-2049205669),expr__45995) : pred__45994.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__45995)))){
return (new ajax.protocols.Response(self__.status,G__45877,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__45994.cljs$core$IFn$_invoke$arity$2 ? pred__45994.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__45995) : pred__45994.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__45995)))){
return (new ajax.protocols.Response(self__.status,self__.body,G__45877,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__45994.cljs$core$IFn$_invoke$arity$2 ? pred__45994.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"headers","headers",-835030129),expr__45995) : pred__45994.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__45995)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__45877,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__45994.cljs$core$IFn$_invoke$arity$2 ? pred__45994.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__45995) : pred__45994.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__45995)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__45877,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__45877),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__45877){
var self__ = this;
var this__5342__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__45877,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__45881){
var extmap__5385__auto__ = (function (){var G__45999 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__45881,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
...
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__45881),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__45881),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__45881),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__45881),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__45881),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
