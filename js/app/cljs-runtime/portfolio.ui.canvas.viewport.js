...
var len__5769__auto___32792 = arguments.length;
var i__5770__auto___32793 = (0);
while(true){
if((i__5770__auto___32793 < len__5769__auto___32792)){
args__5775__auto__.push((arguments[i__5770__auto___32793]));

var G__32794 = (i__5770__auto___32793 + (1));
i__5770__auto___32793 = G__32794;
continue;
} else {
}
break;
...
(portfolio.ui.canvas.viewport.get_width.cljs$core$IFn$_invoke$arity$variadic = (function (frame,frame_body,width,p__32711){
var vec__32713 = p__32711;
var map__32716 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32713,(0),null);
var map__32716__$1 = cljs.core.__destructure_map(map__32716);
var level = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32716__$1,new cljs.core.Keyword("zoom","level","zoom/level",1294076441));
...
/** @this {Function} */
(portfolio.ui.canvas.viewport.get_width.cljs$lang$applyTo = (function (seq32694){
var G__32695 = cljs.core.first(seq32694);
var seq32694__$1 = cljs.core.next(seq32694);
var G__32696 = cljs.core.first(seq32694__$1);
var seq32694__$2 = cljs.core.next(seq32694__$1);
var G__32697 = cljs.core.first(seq32694__$2);
var seq32694__$3 = cljs.core.next(seq32694__$2);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32695,G__32696,G__32697,seq32694__$3);
}));

portfolio.ui.canvas.viewport.get_style_px = (function portfolio$ui$canvas$viewport$get_style_px(style,prop){
var temp__5802__auto__ = (function (){var G__32723 = style;
var G__32723__$1 = (((G__32723 == null))?null:G__32723.getPropertyValue(prop));
if((G__32723__$1 == null)){
return null;
} else {
return cljs.core.not_empty(G__32723__$1);
}
})();
...
var args__5775__auto__ = [];
var len__5769__auto___32796 = arguments.length;
var i__5770__auto___32797 = (0);
while(true){
if((i__5770__auto___32797 < len__5769__auto___32796)){
args__5775__auto__.push((arguments[i__5770__auto___32797]));

var G__32798 = (i__5770__auto___32797 + (1));
i__5770__auto___32797 = G__32798;
continue;
} else {
}
break;
...
(portfolio.ui.canvas.viewport.get_height.cljs$core$IFn$_invoke$arity$variadic = (function (_frame,frame_body,height,p__32739){
var vec__32741 = p__32739;
var map__32744 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32741,(0),null);
var map__32744__$1 = cljs.core.__destructure_map(map__32744);
var level = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32744__$1,new cljs.core.Keyword("zoom","level","zoom/level",1294076441));
var level__$1 = (function (){var or__5045__auto__ = level;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
...
/** @this {Function} */
(portfolio.ui.canvas.viewport.get_height.cljs$lang$applyTo = (function (seq32725){
var G__32726 = cljs.core.first(seq32725);
var seq32725__$1 = cljs.core.next(seq32725);
var G__32727 = cljs.core.first(seq32725__$1);
var seq32725__$2 = cljs.core.next(seq32725__$1);
var G__32728 = cljs.core.first(seq32725__$2);
var seq32725__$3 = cljs.core.next(seq32725__$2);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32726,G__32727,G__32728,seq32725__$3);
}));
...
portfolio.ui.canvas.viewport.prepare_canvas = (function portfolio$ui$canvas$viewport$prepare_canvas(_,el,p__32766){
var map__32767 = p__32766;
var map__32767__$1 = cljs.core.__destructure_map(map__32767);
var opt = map__32767__$1;
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32767__$1,new cljs.core.Keyword("viewport","width","viewport/width",809992237));
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32767__$1,new cljs.core.Keyword("viewport","height","viewport/height",1951335772));
...
portfolio.ui.canvas.viewport.finalize_canvas = (function portfolio$ui$canvas$viewport$finalize_canvas(_,el,p__32771){
var map__32773 = p__32771;
var map__32773__$1 = cljs.core.__destructure_map(map__32773);
var opt = map__32773__$1;
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32773__$1,new cljs.core.Keyword("viewport","width","viewport/width",809992237));
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32773__$1,new cljs.core.Keyword("viewport","height","viewport/height",1951335772));
...
var vec__32774 = ((((((cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2("100%",w)) || (cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2("100%",height)))) && ((((!(typeof width === 'number'))) || ((((40) + width) < portfolio.ui.canvas.viewport.get_available_width(el)))))))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["20px","rgba(0, 0, 0, 0.1) 0px 1px 5px 0px"], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["0","none"], null));
var margin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32774,(0),null);
var shadow__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32774,(1),null);
(el.style.height = h);
...
var vec__32781 = xs__$1;
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32781,(0),null);
var h = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32781,(1),null);
...
var default_value = cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("viewport","defaults","viewport/defaults",2054751788).cljs$core$IFn$_invoke$arity$1(config),new cljs.core.Keyword("viewport","width","viewport/width",809992237),(function (p1__32784_SHARP_){
var or__5045__auto__ = p1__32784_SHARP_;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return "100%";
}
})),new cljs.core.Keyword("viewport","height","viewport/height",1951335772),(function (p1__32785_SHARP_){
var or__5045__auto__ = p1__32785_SHARP_;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return "100%";
...
,new cljs.core.Keyword(null,"default-value","default-value",232220170),default_value,new cljs.core.Keyword(null,"options","options",99638489),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32786_SHARP_){
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(p1__32786_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"value","value",305978217),new cljs.core.Keyword("viewport","padding","viewport/padding",-1583726021)], null),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(portfolio.ui.canvas.viewport.get_padding,default_value));
