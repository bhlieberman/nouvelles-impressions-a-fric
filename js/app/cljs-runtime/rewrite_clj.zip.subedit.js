...
var zloc_SINGLEQUOTE_ = (function (){var G__29442 = zloc;
var G__29442__$1 = (((G__29442 == null))?null:rewrite_clj.custom_zipper.core.node(G__29442));
if((G__29442__$1 == null)){
return null;
} else {
return rewrite_clj.zip.base.of_node_STAR_.cljs$core$IFn$_invoke$arity$2(G__29442__$1,rewrite_clj.zip.options.get_opts(zloc));
}
})();
...
var zloc_SINGLEQUOTE_ = (function (){var G__29449 = rewrite_clj.zip.subedit.subzip(zloc);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__29449) : f.call(null,G__29449));
})();
if((!((zloc_SINGLEQUOTE_ == null)))){
} else {
