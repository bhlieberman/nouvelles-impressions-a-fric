...
import "./rewrite_clj.zip.editz.js";
import "./rewrite_clj.zip.findz.js";
import "./rewrite_clj.zip.insert.js";
...
var G__30526 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(zloc_n0) : f.call(null,zloc_n0));
var G__30526__$1 = (((G__30526 == null))?null:cljs.core.iterate((function (loc){
...
var G__30526__$2 = (((G__30526__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__30526__$1));
var G__30526__$3 = (((G__30526__$2 == null))?null:cljs.core.last(G__30526__$2));
if((G__30526__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__30526__$3);
}
} else {
return zloc;
}
...
var G__30616 = rewrite_clj.zip.move.right(new_zloc_map_value);
var G__30617 = rewrite_clj.zip.move.up(new_zloc_map_value);
loc = G__30616;
parent = G__30617;
continue;
} else {
var G__30618 = rewrite_clj.zip.move.right(zloc_map_value);
var G__30619 = parent;
loc = G__30618;
parent = G__30619;
continue;
...
var G__30629 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(zloc_map_key));
var G__30630 = rewrite_clj.zip.move.up(zloc_map_key);
loc = G__30629;
parent = G__30630;
continue;
} else {
var G__30631 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__30632 = parent;
loc = G__30631;
parent = G__30632;
continue;
...
var G__30587 = zloc;
var G__30587__$1 = (((G__30587 == null))?null:rewrite_clj.zip.move.down(G__30587));
var G__30587__$2 = (((G__30587__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__30587__$1,k));
if((G__30587__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__30587__$2);
}
} else {
if(rewrite_clj.zip.seqz.namespaced_map_QMARK_(zloc)){
var G__30592 = zloc;
var G__30592__$1 = (((G__30592 == null))?null:rewrite_clj.zip.move.down(G__30592));
var G__30592__$2 = (((G__30592__$1 == null))?null:rewrite_clj.zip.move.rightmost(G__30592__$1));
var G__30592__$3 = (((G__30592__$2 == null))?null:rewrite_clj.zip.move.down(G__30592__$2));
var G__30592__$4 = (((G__30592__$3 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__30592__$3,k));
if((G__30592__$4 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__30592__$4);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__30596 = rewrite_clj.zip.move.down(zloc);
var G__30596__$1 = (((G__30596 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__30596));
if((G__30596__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__30596__$1);
}
})(),k);
