...
var sci$impl$types$IBox$setVal$dyn_30080 = (function (_this,_v){
...
return sci$impl$types$IBox$setVal$dyn_30080(_this,_v);
}
});

var sci$impl$types$IBox$getVal$dyn_30081 = (function (_this){
var x__5393__auto__ = (((_this == null))?null:_this);
...
return sci$impl$types$IBox$getVal$dyn_30081(_this);
}
});
...
var sci$impl$types$IReified$getInterfaces$dyn_30082 = (function (_){
...
return sci$impl$types$IReified$getInterfaces$dyn_30082(_);
}
});

var sci$impl$types$IReified$getMethods$dyn_30088 = (function (_){
var x__5393__auto__ = (((_ == null))?null:_);
...
return sci$impl$types$IReified$getMethods$dyn_30088(_);
}
});

var sci$impl$types$IReified$getProtocols$dyn_30089 = (function (_){
var x__5393__auto__ = (((_ == null))?null:_);
...
return sci$impl$types$IReified$getProtocols$dyn_30089(_);
}
});
...
var sci$impl$types$SciTypeInstance$_get_type$dyn_30091 = (function (_){
var x__5393__auto__ = (((_ == null))?null:_);
...
return sci$impl$types$SciTypeInstance$_get_type$dyn_30091(_);
}
});

var sci$impl$types$SciTypeInstance$_mutate$dyn_30103 = (function (_,k,v){
var x__5393__auto__ = (((_ == null))?null:_);
...
return sci$impl$types$SciTypeInstance$_mutate$dyn_30103(_,k,v);
}
});
...
var or__5045__auto____$2 = (function (){var G__29948 = x;
var G__29948__$1 = (((G__29948 == null))?null:cljs.core.meta(G__29948));
if((G__29948__$1 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(G__29948__$1);
}
})();
...
/** @this {Function} */
(sci.impl.types.type_impl.cljs$lang$applyTo = (function (seq29936){
var G__29937 = cljs.core.first(seq29936);
var seq29936__$1 = cljs.core.next(seq29936);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29937,seq29936__$1);
}));
...
var or__5045__auto____$1 = (function (){var G__29962 = x;
var G__29962__$1 = (((G__29962 == null))?null:cljs.core.meta(G__29962));
if((G__29962__$1 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(G__29962__$1);
}
})();
if(cljs.core.truth_(or__5045__auto____$1)){
return or__5045__auto____$1;
...
var sci$impl$types$Stack$stack$dyn_30113 = (function (this$){
...
return sci$impl$types$Stack$stack$dyn_30113(this$);
}
});
...
(sci.impl.types.NodeR.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k29997,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k29997,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__30017){
var vec__30019 = p__30017;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30019,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30019,(1),null);
...
(sci.impl.types.NodeR.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__29996){
var self__ = this;
var G__29996__$1 = this;
return (new cljs.core.RecordIter((0),G__29996__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"f","f",-1597136552),new cljs.core.Keyword(null,"stack","stack",-793405930)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(sci.impl.types.NodeR.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this29998,other29999){
var self__ = this;
var this29998__$1 = this;
return (((!((other29999 == null)))) && ((((this29998__$1.constructor === other29999.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29998__$1.f,other29999.f)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29998__$1.stack,other29999.stack)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29998__$1.__extmap,other29999.__extmap)))))))));
}));
...
(sci.impl.types.NodeR.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k29997){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k29997);

}
}));

(sci.impl.types.NodeR.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__29996){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__30044 = cljs.core.keyword_identical_QMARK_;
var expr__30045 = k__5352__auto__;
if(cljs.core.truth_((pred__30044.cljs$core$IFn$_invoke$arity$2 ? pred__30044.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"f","f",-1597136552),expr__30045) : pred__30044.call(null,new cljs.core.Keyword(null,"f","f",-1597136552),expr__30045)))){
return (new sci.impl.types.NodeR(G__29996,self__.stack,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__30044.cljs$core$IFn$_invoke$arity$2 ? pred__30044.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"stack","stack",-793405930),expr__30045) : pred__30044.call(null,new cljs.core.Keyword(null,"stack","stack",-793405930),expr__30045)))){
return (new sci.impl.types.NodeR(self__.f,G__29996,self__.__meta,self__.__extmap,null));
} else {
return (new sci.impl.types.NodeR(self__.f,self__.stack,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__29996),null));
}
}
}));
...
(sci.impl.types.NodeR.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__29996){
var self__ = this;
var this__5342__auto____$1 = this;
return (new sci.impl.types.NodeR(self__.f,self__.stack,G__29996,self__.__extmap,self__.__hash));
}));
 ...
 */
sci.impl.types.map__GT_NodeR = (function sci$impl$types$map__GT_NodeR(G__30001){
var extmap__5385__auto__ = (function (){var G__30058 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__30001,new cljs.core.Keyword(null,"f","f",-1597136552),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"stack","stack",-793405930)], 0));
if(cljs.core.record_QMARK_(G__30001)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__30058);
} else {
return G__30058;
}
})();
return (new sci.impl.types.NodeR(new cljs.core.Keyword(null,"f","f",-1597136552).cljs$core$IFn$_invoke$arity$1(G__30001),new cljs.core.Keyword(null,"stack","stack",-793405930).cljs$core$IFn$_invoke$arity$1(G__30001),null,cljs.core.not_empty(extmap__5385__auto__),null));
});

sci.impl.types.eval = (function sci$impl$types$eval(expr,ctx,bindings){
if((expr instanceof sci.impl.types.NodeR)){
var fexpr__30060 = expr.f;
return (fexpr__30060.cljs$core$IFn$_invoke$arity$3 ? fexpr__30060.cljs$core$IFn$_invoke$arity$3(expr,ctx,bindings) : fexpr__30060.call(null,expr,ctx,bindings));
} else {
return expr;
}
});
...
var sci$impl$types$HasName$getName$dyn_30137 = (function (_){
var x__5393__auto__ = (((_ == null))?null:_);
...
return sci$impl$types$HasName$getName$dyn_30137(_);
}
});
