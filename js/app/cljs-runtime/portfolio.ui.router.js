...
var G__29716 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(query_string,/&/);
var G__29716__$1 = (((G__29716 == null))?null:cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.empty_QMARK_,G__29716));
var G__29716__$2 = (((G__29716__$1 == null))?null:cljs.core.seq(G__29716__$1));
var G__29716__$3 = (((G__29716__$2 == null))?null:cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (s){
if(cljs.core.truth_(cljs.core.re_find(/=/,s))){
var vec__29722 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(s,/=/);
...
if((G__29716__$3 == null)){
return null;
} else {
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__29716__$3);
}
});
portfolio.ui.router.get_location = (function portfolio$ui$router$get_location(url){
var vec__29727 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(url,/#/);
var url__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29727,(0),null);
var hash = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29727,(1),null);
var vec__29730 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(url__$1,/\?/);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29730,(0),null);
var query = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29730,(1),null);
var G__29737 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"path","path",-188191168),path], null);
var G__29737__$1 = ((typeof query === 'string')?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__29737,new cljs.core.Keyword(null,"query-params","query-params",900640534),portfolio.ui.router.parse_query_params(query)):G__29737);
if(typeof hash === 'string'){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__29737__$1,new cljs.core.Keyword(null,"hash","hash",-13781596),hash);
} else {
return G__29737__$1;
}
});
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("&",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__29750){
