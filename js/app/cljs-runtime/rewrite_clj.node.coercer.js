...
import "./rewrite_clj.node.integer.js";
import "./rewrite_clj.node.keyword.js";
import "./rewrite_clj.node.meta.js";
import "./rewrite_clj.node.namespaced_map.js";
...
import "./rewrite_clj.parser.impl.js";
...
var comma_27691 = rewrite_clj.node.whitespace.whitespace_nodes(", ");
var space_27692 = rewrite_clj.node.whitespace.whitespace_node(" ");
rewrite_clj.node.coercer.map__GT_children = (function rewrite_clj$node$coercer$map__GT_children(m){
return cljs.core.vec(cljs.core.drop_last.cljs$core$IFn$_invoke$arity$2(cljs.core.count(comma_27691),cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__27670){
var vec__27672 = p__27670;
...
return cljs.core.list_STAR_.cljs$core$IFn$_invoke$arity$4(rewrite_clj.node.protocols.coerce(k),space_27692,rewrite_clj.node.protocols.coerce(v),comma_27691);
...
return rewrite_clj.node.coercer.node_with_meta((function (){var G__27679 = cljs.core.vec(rewrite_clj.node.whitespace.space_separated(cljs.core.map.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.coerce,sq)));
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__27679) : f.call(null,G__27679));
})(),sq);
});
