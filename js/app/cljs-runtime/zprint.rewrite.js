...
var G__34238 = rewrite_clj.zip.next(n);
loc = G__34238;
continue;
} else {
var G__34239 = rewrite_clj.zip.next(loc);
loc = G__34239;
continue;
}
} else {
var G__34240 = rewrite_clj.zip.next(loc);
loc = G__34240;
continue;
}
}
...
return rewrite_clj.zip.replace(zloc,rewrite_clj.zip.root(zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__34110 = zloc;
var G__34110__$1 = (((G__34110 == null))?null:rewrite_clj.zip.node(G__34110));
if((G__34110__$1 == null)){
return null;
} else {
return rewrite_clj.zip.of_node_STAR_.cljs$core$IFn$_invoke$arity$1(G__34110__$1);
}
})())));
});
/**
...
var G__34252 = rewrite_clj.zip.down(nloc);
nloc = G__34252;
continue;
}
break;
...
var G__34253 = rewrite_clj.zip.right(nloc);
var G__34254 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__34253;
out = G__34254;
continue;
} else {
...
var G__34260 = rewrite_clj.zip.right(replaced_loc);
var G__34261 = cljs.core.next(new_loc);
var G__34262 = replaced_loc;
nloc = G__34260;
new_loc = G__34261;
last_loc = G__34262;
continue;
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__34204_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.tag(p1__34204_SHARP_),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.sexpr(p1__34204_SHARP_),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
