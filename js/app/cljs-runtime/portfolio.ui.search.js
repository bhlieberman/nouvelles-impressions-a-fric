...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.first,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p__32269){
var vec__32270 = p__32269;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32270,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32270,(1),null);
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__32281){
...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__32295_SHARP_){
return ((typeof p1__32295_SHARP_ === 'string') || ((p1__32295_SHARP_ instanceof cljs.core.Keyword)));
...
*/
portfolio.ui.search.t_portfolio$ui$search32304 = (function (index,meta32305){
this.index = index;
this.meta32305 = meta32305;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(portfolio.ui.search.t_portfolio$ui$search32304.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_32306,meta32305__$1){
var self__ = this;
var _32306__$1 = this;
return (new portfolio.ui.search.t_portfolio$ui$search32304(self__.index,meta32305__$1));
}));

(portfolio.ui.search.t_portfolio$ui$search32304.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_32306){
var self__ = this;
var _32306__$1 = this;
return self__.meta32305;
}));

(portfolio.ui.search.t_portfolio$ui$search32304.prototype.portfolio$ui$search$protocols$Index$ = cljs.core.PROTOCOL_SENTINEL);

(portfolio.ui.search.t_portfolio$ui$search32304.prototype.portfolio$ui$search$protocols$Index$index$arity$2 = (function (_,doc){
var self__ = this;
var ___$1 = this;
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$3(self__.index,portfolio.ui.search.index_scene,doc);
}));

(portfolio.ui.search.t_portfolio$ui$search32304.prototype.portfolio$ui$search$protocols$Index$query$arity$2 = (function (_,q){
var self__ = this;
var ___$1 = this;
return portfolio.ui.search.search(cljs.core.deref(self__.index),q);
}));

(portfolio.ui.search.t_portfolio$ui$search32304.getBasis = (function (){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"index","index",108845612,null),new cljs.core.Symbol(null,"meta32305","meta32305",256798653,null)], null);
}));

(portfolio.ui.search.t_portfolio$ui$search32304.cljs$lang$type = true);

(portfolio.ui.search.t_portfolio$ui$search32304.cljs$lang$ctorStr = "portfolio.ui.search/t_portfolio$ui$search32304");

(portfolio.ui.search.t_portfolio$ui$search32304.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"portfolio.ui.search/t_portfolio$ui$search32304");
}));

/**
 * Positional factory function for portfolio.ui.search/t_portfolio$ui$search32304.
 */
portfolio.ui.search.__GT_t_portfolio$ui$search32304 = (function portfolio$ui$search$__GT_t_portfolio$ui$search32304(index,meta32305){
return (new portfolio.ui.search.t_portfolio$ui$search32304(index,meta32305));
});
...
return (new portfolio.ui.search.t_portfolio$ui$search32304(index,cljs.core.PersistentArrayMap.EMPTY));
});
...
return cljs.core.chunk_cons(cljs.core.chunk(b__32516),portfolio$ui$search$prepare_search_$_iter__32513(cljs.core.chunk_rest(s__32514__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__32516),null);
}
} else {
var result = cljs.core.first(s__32514__$2);
return cljs.core.cons((((function (){var G__32535 = new cljs.core.Keyword(null,"index","index",-1531685915).cljs$core$IFn$_invoke$arity$1(state);
if((!((G__32535 == null)))){
if(((false) || ((cljs.core.PROTOCOL_SENTINEL === G__32535.portfolio$ui$search$protocols$SearchResult$)))){
return true;
} else {
if((!G__32535.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_(portfolio.ui.search.protocols.SearchResult,G__32535);
} else {
return false;
}
}
...
})())?portfolio.ui.search.protocols.prepare_result(new cljs.core.Keyword(null,"index","index",-1531685915).cljs$core$IFn$_invoke$arity$1(state),state,location,result):portfolio.ui.search.prepare_result(state,location,result)),portfolio$ui$search$prepare_search_$_iter__32513(cljs.core.rest(s__32514__$2)));
}
} else {
return null;
}
