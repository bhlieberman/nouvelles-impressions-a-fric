...
var len__5769__auto___16757 = arguments.length;
var i__5770__auto___16758 = (0);
while(true){
if((i__5770__auto___16758 < len__5769__auto___16757)){
args__5775__auto__.push((arguments[i__5770__auto___16758]));

var G__16759 = (i__5770__auto___16758 + (1));
i__5770__auto___16758 = G__16759;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq16656){
var G__16659 = cljs.core.first(seq16656);
var seq16656__$1 = cljs.core.next(seq16656);
var G__16660 = cljs.core.first(seq16656__$1);
var seq16656__$2 = cljs.core.next(seq16656__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__16659,G__16660,seq16656__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__16687_SHARP_){
return (!((cljs.core.meta(p1__16687_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16719__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e16720){var _e__15459__auto__ = e16720;
return false;
}})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
}catch (e16727){var _e__15459__auto__ = e16727;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__16746 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__16747 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__16747);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16748__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__16746);
}});
...
var temp__5802__auto___16778 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___16778)){
var managed_print_level_16779 = temp__5802__auto___16778;
var _STAR_print_level_STAR__orig_val__16751_16780 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__16752_16781 = managed_print_level_16779;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__16752_16781);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__16750_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__16750_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__16751_16780);
}} else {
job_fn();
}
