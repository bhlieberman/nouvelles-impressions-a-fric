 ...
 * 
 */
portfolio.ui.components.menu_bar.MenuBar = (function (){var G__31728 = (function (p__31730){
var map__31731 = p__31730;
var map__31731__$1 = cljs.core.__destructure_map(map__31731);
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31731__$1,new cljs.core.Keyword(null,"title","title",636505583));
var action = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31731__$1,new cljs.core.Keyword(null,"action","action",-811238024));
var illustration = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31731__$1,new cljs.core.Keyword(null,"illustration","illustration",-48860973));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31731__$1,new cljs.core.Keyword(null,"size","size",1098693007));
...
,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"size","size",1098693007),(16)], null)], 0)),(function (){var iter__5523__auto__ = (function portfolio$ui$components$menu_bar$iter__31738(s__31739){
return (new cljs.core.LazySeq(null,(function (){
var s__31739__$1 = s__31739;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__31739__$1);
if(temp__5804__auto__){
var s__31739__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__31739__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__31739__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__31741 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__31740 = (0);
while(true){
if((i__31740 < size__5522__auto__)){
var map__31746 = cljs.core._nth(c__5521__auto__,i__31740);
var map__31746__$1 = cljs.core.__destructure_map(map__31746);
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31746__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31746__$1,new cljs.core.Keyword(null,"url","url",276297046));
cljs.core.chunk_append(b__31741,(cljs.core.truth_(url)?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a","a",-2123407586),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"color","color",1011675173),"var(--subdued-link)"], null),new cljs.core.Keyword(null,"href","href",-793805698),url], null),text], null):text));

var G__31789 = (i__31740 + (1));
i__31740 = G__31789;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__31741),portfolio$ui$components$menu_bar$iter__31738(cljs.core.chunk_rest(s__31739__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__31741),null);
}
} else {
var map__31752 = cljs.core.first(s__31739__$2);
var map__31752__$1 = cljs.core.__destructure_map(map__31752);
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31752__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31752__$1,new cljs.core.Keyword(null,"url","url",276297046));
return cljs.core.cons((cljs.core.truth_(url)?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a","a",-2123407586),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"color","color",1011675173),"var(--subdued-link)"], null),new cljs.core.Keyword(null,"href","href",-793805698),url], null),text], null):text),portfolio$ui$components$menu_bar$iter__31738(cljs.core.rest(s__31739__$2)));
}
} else {
return null;
}
...
return iter__5523__auto__(title);
...
var G__31729 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"name","name",1843675177),"portfolio.ui.components.menu-bar/MenuBar"], null);
return (dumdom.core.component.cljs$core$IFn$_invoke$arity$2 ? dumdom.core.component.cljs$core$IFn$_invoke$arity$2(G__31728,G__31729) : dumdom.core.component.call(null,G__31728,G__31729));
})();
