...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__52941_SHARP_,p2__52942_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__52941_SHARP_,p2__52942_SHARP_,reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false));
}),tour_map,tour_spec);
});
/**
...
return cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__5523__auto__ = (function re_com$tour$initialise_tour_$_iter__52951(s__52952){
return (new cljs.core.LazySeq(null,(function (){
var s__52952__$1 = s__52952;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__52952__$1);
if(temp__5804__auto__){
var s__52952__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__52952__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__52952__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__52954 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__52953 = (0);
while(true){
if((i__52953 < size__5522__auto__)){
var step = cljs.core._nth(c__5521__auto__,i__52953);
cljs.core.chunk_append(b__52954,cljs.core.reset_BANG_((step.cljs$core$IFn$_invoke$arity$1 ? step.cljs$core$IFn$_invoke$arity$1(tour) : step.call(null,tour)),false));

var G__53014 = (i__52953 + (1));
i__52953 = G__53014;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__52954),re_com$tour$initialise_tour_$_iter__52951(cljs.core.chunk_rest(s__52952__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__52954),null);
}
} else {
var step = cljs.core.first(s__52952__$2);
return cljs.core.cons(cljs.core.reset_BANG_((step.cljs$core$IFn$_invoke$arity$1 ? step.cljs$core$IFn$_invoke$arity$1(tour) : step.call(null,tour)),false),re_com$tour$initialise_tour_$_iter__52951(cljs.core.rest(s__52952__$2)));
}
} else {
return null;
}
...
return cljs.core.reset_BANG_((function (){var fexpr__52971 = cljs.core.first(new cljs.core.Keyword(null,"steps","steps",-128433302).cljs$core$IFn$_invoke$arity$1(tour));
return (fexpr__52971.cljs$core$IFn$_invoke$arity$1 ? fexpr__52971.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__52971.call(null,tour));
})(),true);
});
/**
...
cljs.core.reset_BANG_((function (){var fexpr__52980 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,old_step);
return (fexpr__52980.cljs$core$IFn$_invoke$arity$1 ? fexpr__52980.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__52980.call(null,tour));
})(),false);

return cljs.core.reset_BANG_((function (){var fexpr__52981 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,new_step);
return (fexpr__52981.cljs$core$IFn$_invoke$arity$1 ? fexpr__52981.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__52981.call(null,tour));
})(),true);
} else {
return null;
}
...
cljs.core.reset_BANG_((function (){var fexpr__52983 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,old_step);
return (fexpr__52983.cljs$core$IFn$_invoke$arity$1 ? fexpr__52983.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__52983.call(null,tour));
})(),false);

return cljs.core.reset_BANG_((function (){var fexpr__52987 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,new_step);
return (fexpr__52987.cljs$core$IFn$_invoke$arity$1 ? fexpr__52987.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__52987.call(null,tour));
})(),true);
} else {
return null;
}
