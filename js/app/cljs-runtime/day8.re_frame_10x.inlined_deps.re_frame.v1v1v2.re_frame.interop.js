...
import "./day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.core.js";
...
return [(function (){var pred__18564 = cljs.core.instance_QMARK_;
var expr__18565 = reactive_val;
if(cljs.core.truth_((pred__18564.cljs$core$IFn$_invoke$arity$2 ? pred__18564.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RAtom,expr__18565) : pred__18564.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RAtom,expr__18565)))){
return "ra";
} else {
if(cljs.core.truth_((pred__18564.cljs$core$IFn$_invoke$arity$2 ? pred__18564.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RCursor,expr__18565) : pred__18564.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RCursor,expr__18565)))){
return "rc";
} else {
if(cljs.core.truth_((pred__18564.cljs$core$IFn$_invoke$arity$2 ? pred__18564.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Reaction,expr__18565) : pred__18564.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Reaction,expr__18565)))){
return "rx";
} else {
if(cljs.core.truth_((pred__18564.cljs$core$IFn$_invoke$arity$2 ? pred__18564.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Track,expr__18565) : pred__18564.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Track,expr__18565)))){
return "tr";
} else {
return "other";
}
