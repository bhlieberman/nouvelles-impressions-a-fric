...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_34836 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_34836(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_34837 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_34837(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_34847 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_34847(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_34854 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_34854(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_34872 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_34872(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_34879 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_34879(reader);
}
});
...
var G__34938 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__34939 = s.append(c);
c = G__34938;
s = G__34939;
continue;
}
