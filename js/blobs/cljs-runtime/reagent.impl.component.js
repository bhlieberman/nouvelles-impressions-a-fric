...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__32057 = c;
var G__32057__$1 = (((G__32057 == null))?null:G__32057.prototype);
if((G__32057__$1 == null)){
return null;
} else {
return G__32057__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__32058 = c;
var G__32058__$1 = (((G__32058 == null))?null:G__32058.prototype);
if((G__32058__$1 == null)){
return null;
} else {
return G__32058__$1.render;
}
})() == null)))));
});
...
var args = cljs.core.seq(arglist__32246);
...
var or__5045__auto__ = (function (){var G__32094 = c;
var G__32094__$1 = (((G__32094 == null))?null:G__32094.constructor);
if((G__32094__$1 == null)){
return null;
} else {
return G__32094__$1.displayName;
}
})();
...
var G__32099 = c;
var G__32099__$1 = (((G__32099 == null))?null:G__32099.constructor);
if((G__32099__$1 == null)){
return null;
} else {
return G__32099__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__32109 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__32110 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__32110);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__32109);
}});
...
var c = this;
var G__32163_32253 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__32163_32253 == null)){
} else {
reagent.ratom.dispose_BANG_(G__32163_32253);
}
...
var renders_32256 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_32257 = cljs.core.first(cljs.core.vals(renders_32256));
...
if((cljs.core.count(renders_32256) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_32256))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_32257)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_32257], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__32199 = o;
reagent.impl.component.goog$module$goog$object.set(G__32199,cljs.core.name(k),v);
...
while (G__32294__i < G__32294__a.length) {G__32294__a[G__32294__i] = arguments[G__32294__i + 0]; ++G__32294__i;}
  args = new cljs.core.IndexedSeq(G__32294__a,0,null);
} 
...
var _STAR_current_component_STAR__orig_val__32216 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__32217 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__32217);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__32216);
}});
...
var vec__32223 = shadow.esm.esm_import$react.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32223,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32223,(1),null);
...
var G__32229 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__32229 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__32229);
}
});
}),[]);
