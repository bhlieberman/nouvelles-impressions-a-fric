...
var periods__$1 = cljs.core.vec((function (){var G__36602 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__36601_SHARP_){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__36601_SHARP_,(0),(3));
}),G__36602);
} else {
return G__36602;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__36608){
var vec__36609 = p__36608;
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36609,(0),null);
var pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36609,(1),null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__36612 = pattern;
switch (G__36612) {
case "S":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__36612)].join('')));
...
return p1__36613_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__36614_SHARP_){
return p1__36614_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__36615_SHARP_){
return p1__36615_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__36616_SHARP_){
return p1__36616_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__36617_SHARP_){
return p1__36617_SHARP_.getHours();
});

break;
case "day":
return (function (p1__36618_SHARP_){
return p1__36618_SHARP_.getDate();
});

break;
case "month":
return (function (p1__36619_SHARP_){
return p1__36619_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__36620_SHARP_){
return p1__36620_SHARP_.getYear();
});

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__36621__$1)].join('')));

}
});
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__36624){
var vec__36625 = p__36624;
var seq__36626 = cljs.core.seq(vec__36625);
var first__36627 = cljs.core.first(seq__36626);
var seq__36626__$1 = cljs.core.next(seq__36626);
var key = first__36627;
var args = seq__36626__$1;
var G__36628 = key;
...
break;
case "ordinal-suffix":
var vec__36630 = (function (){var G__36633 = (i - (1));
return (syntax_list.cljs$core$IFn$_invoke$arity$1 ? syntax_list.cljs$core$IFn$_invoke$arity$1(G__36633) : syntax_list.call(null,G__36633));
})();
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36630,(0),null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__36628__$1)].join('')));
...
var d = value;
var G__36637 = cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__36638 = G__36637;
var seq__36639 = cljs.core.seq(vec__36638);
var first__36640 = cljs.core.first(seq__36639);
var seq__36639__$1 = cljs.core.next(seq__36639);
var unparser = first__36640;
var more = seq__36639__$1;
var s = "";
var d__$1 = d;
var G__36637__$1 = G__36637;
var s__$1 = s;
while(true){
var d__$2 = d__$1;
var vec__36647 = G__36637__$1;
var seq__36648 = cljs.core.seq(vec__36647);
var first__36649 = cljs.core.first(seq__36648);
var seq__36648__$1 = cljs.core.next(seq__36648);
var unparser__$1 = first__36649;
var more__$1 = seq__36648__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__36650 = (unparser__$1.cljs$core$IFn$_invoke$arity$2 ? unparser__$1.cljs$core$IFn$_invoke$arity$2(s__$2,d__$2) : unparser__$1.call(null,s__$2,d__$2));
var s__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36650,(0),null);
var d__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36650,(1),null);
var G__36675 = d__$3;
var G__36676 = more__$1;
var G__36677 = s__$3;
d__$1 = G__36675;
G__36637__$1 = G__36676;
s__$1 = G__36677;
continue;
}
break;
