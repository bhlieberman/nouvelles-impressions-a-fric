...
re_com.simple_v_table.swap_BANG__sort_by_column = (function re_com$simple_v_table$swap_BANG__sort_by_column(p__37731,new_key_fn,new_comp){
var map__37736 = p__37731;
var map__37736__$1 = cljs.core.__destructure_map(map__37736);
var key_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37736__$1,new cljs.core.Keyword(null,"key-fn","key-fn",-636154479));
var order = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37736__$1,new cljs.core.Keyword(null,"order","order",-1254677256));
...
re_com.simple_v_table.column_header_item = (function re_com$simple_v_table$column_header_item(p__37740,parts,sort_by_column){
var map__37741 = p__37740;
var map__37741__$1 = cljs.core.__destructure_map(map__37741);
var column = map__37741__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37741__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var row_label_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37741__$1,new cljs.core.Keyword(null,"row-label-fn","row-label-fn",1457434308));
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37741__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37741__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var align = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37741__$1,new cljs.core.Keyword(null,"align","align",1964212802));
var vertical_align = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37741__$1,new cljs.core.Keyword(null,"vertical-align","vertical-align",651007333));
var header_label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37741__$1,new cljs.core.Keyword(null,"header-label","header-label",765876429));
var sort_by = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37741__$1,new cljs.core.Keyword(null,"sort-by","sort-by",-322599303));
var map__37745 = sort_by;
var map__37745__$1 = cljs.core.__destructure_map(map__37745);
var key_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__37745__$1,new cljs.core.Keyword(null,"key-fn","key-fn",-636154479),row_label_fn);
var comp = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__37745__$1,new cljs.core.Keyword(null,"comp","comp",1191953630),cljs.core.compare);
var map__37746 = cljs.core.deref(sort_by_column);
var map__37746__$1 = cljs.core.__destructure_map(map__37746);
var current_key_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37746__$1,new cljs.core.Keyword(null,"key-fn","key-fn",-636154479));
var order = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37746__$1,new cljs.core.Keyword(null,"order","order",-1254677256));
...
return null;
})], null),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"simple-column-header","simple-column-header",-1241463404),new cljs.core.Keyword(null,"attr","attr",-604132353)], null))], 0))], null),(function (){var iter__5523__auto__ = (function re_com$simple_v_table$column_header_renderer_$_iter__37747(s__37748){
return (new cljs.core.LazySeq(null,(function (){
var s__37748__$1 = s__37748;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__37748__$1);
if(temp__5804__auto__){
var s__37748__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__37748__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__37748__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__37750 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__37749 = (0);
while(true){
if((i__37749 < size__5522__auto__)){
var column = cljs.core._nth(c__5521__auto__,i__37749);
cljs.core.chunk_append(b__37750,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.simple_v_table.column_header_item,column,parts,sort_by_column], null));

var G__37791 = (i__37749 + (1));
i__37749 = G__37791;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__37750),re_com$simple_v_table$column_header_renderer_$_iter__37747(cljs.core.chunk_rest(s__37748__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__37750),null);
}
} else {
var column = cljs.core.first(s__37748__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.simple_v_table.column_header_item,column,parts,sort_by_column], null),re_com$simple_v_table$column_header_renderer_$_iter__37747(cljs.core.rest(s__37748__$2)));
}
} else {
return null;
}
 ...
 */
re_com.simple_v_table.row_item = (function re_com$simple_v_table$row_item(row,p__37753,cell_style,parts){
var map__37754 = p__37753;
var map__37754__$1 = cljs.core.__destructure_map(map__37754);
var column = map__37754__$1;
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37754__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37754__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var align = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37754__$1,new cljs.core.Keyword(null,"align","align",1964212802));
var vertical_align = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37754__$1,new cljs.core.Keyword(null,"vertical-align","vertical-align",651007333));
var row_label_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37754__$1,new cljs.core.Keyword(null,"row-label-fn","row-label-fn",1457434308));
...
return null;
}):null)], null),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"simple-row","simple-row",-252554766),new cljs.core.Keyword(null,"attr","attr",-604132353)], null))], 0))], null),(function (){var iter__5523__auto__ = (function re_com$simple_v_table$row_renderer_$_iter__37758(s__37759){
return (new cljs.core.LazySeq(null,(function (){
var s__37759__$1 = s__37759;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__37759__$1);
if(temp__5804__auto__){
var s__37759__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__37759__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__37759__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__37761 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__37760 = (0);
while(true){
if((i__37760 < size__5522__auto__)){
var column = cljs.core._nth(c__5521__auto__,i__37760);
cljs.core.chunk_append(b__37761,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.simple_v_table.row_item,row,column,cell_style,parts], null));

var G__37804 = (i__37760 + (1));
i__37760 = G__37804;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__37761),re_com$simple_v_table$row_renderer_$_iter__37758(cljs.core.chunk_rest(s__37759__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__37761),null);
}
} else {
var column = cljs.core.first(s__37759__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.simple_v_table.row_item,row,column,cell_style,parts], null),re_com$simple_v_table$row_renderer_$_iter__37758(cljs.core.rest(s__37759__$2)));
}
} else {
return null;
}
...
re_com.simple_v_table.simple_v_table_parts_desc = ((re_com.config.include_args_desc_QMARK_)?cljs.core.into.cljs$core$IFn$_invoke$arity$2(re_com.simple_v_table.simple_v_table_exclusive_parts_desc,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__37762_SHARP_){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(p1__37762_SHARP_,new cljs.core.Keyword(null,"level","level",1290497552),cljs.core.inc);
...
var len__5769__auto___37805 = arguments.length;
var i__5770__auto___37806 = (0);
while(true){
if((i__5770__auto___37806 < len__5769__auto___37805)){
args__5775__auto__.push((arguments[i__5770__auto___37806]));

var G__37807 = (i__5770__auto___37806 + (1));
i__5770__auto___37806 = G__37807;
continue;
} else {
}
break;
...
(re_com.simple_v_table.simple_v_table.cljs$core$IFn$_invoke$arity$variadic = (function (p__37773){
var map__37774 = p__37773;
var map__37774__$1 = cljs.core.__destructure_map(map__37774);
var args = map__37774__$1;
var src = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37774__$1,new cljs.core.Keyword(null,"src","src",-1651076051));
...
return (function() { 
var re_com$simple_v_table$simple_v_table_render__delegate = function (p__37776){
var map__37777 = p__37776;
var map__37777__$1 = cljs.core.__destructure_map(map__37777);
var args__$1 = map__37777__$1;
var cell_style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37777__$1,new cljs.core.Keyword(null,"cell-style","cell-style",1087536089));
var model = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37777__$1,new cljs.core.Keyword(null,"model","model",331153215));
var on_leave_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37777__$1,new cljs.core.Keyword(null,"on-leave-row","on-leave-row",1361264390));
var columns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37777__$1,new cljs.core.Keyword(null,"columns","columns",1998437288));
var parts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37777__$1,new cljs.core.Keyword(null,"parts","parts",849007691));
var on_enter_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37777__$1,new cljs.core.Keyword(null,"on-enter-row","on-enter-row",-139996948));
var row_height = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__37777__$1,new cljs.core.Keyword(null,"row-height","row-height",527360749),(31));
var max_width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37777__$1,new cljs.core.Keyword(null,"max-width","max-width",-1939924051));
var src__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37777__$1,new cljs.core.Keyword(null,"src","src",-1651076051));
var on_click_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37777__$1,new cljs.core.Keyword(null,"on-click-row","on-click-row",-383826673));
var table_row_line_color = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__37777__$1,new cljs.core.Keyword(null,"table-row-line-color","table-row-line-color",680569135),"#EAEEF1");
var table_padding = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__37777__$1,new cljs.core.Keyword(null,"table-padding","table-padding",-702873839),(19));
var column_header_height = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__37777__$1,new cljs.core.Keyword(null,"column-header-height","column-header-height",-1680092558),(31));
var debug_as = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37777__$1,new cljs.core.Keyword(null,"debug-as","debug-as",283322354));
var max_rows = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37777__$1,new cljs.core.Keyword(null,"max-rows","max-rows",-2131113613));
var row_style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37777__$1,new cljs.core.Keyword(null,"row-style","row-style",1352472052));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37777__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var fixed_column_border_color = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__37777__$1,new cljs.core.Keyword(null,"fixed-column-border-color","fixed-column-border-color",2036669142),"#BBBEC0");
var column_header_renderer = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__37777__$1,new cljs.core.Keyword(null,"column-header-renderer","column-header-renderer",-1886265578),re_com.simple_v_table.column_header_renderer);
var fixed_column_count = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__37777__$1,new cljs.core.Keyword(null,"fixed-column-count","fixed-column-count",721535030),(0));
...
var map__37779 = temp__5802__auto__;
var map__37779__$1 = cljs.core.__destructure_map(map__37779);
var key_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37779__$1,new cljs.core.Keyword(null,"key-fn","key-fn",-636154479));
var comp = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__37779__$1,new cljs.core.Keyword(null,"comp","comp",1191953630),cljs.core.compare);
var order = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37779__$1,new cljs.core.Keyword(null,"order","order",-1254677256));
...
while (G__37810__i < G__37810__a.length) {G__37810__a[G__37810__i] = arguments[G__37810__i + 0]; ++G__37810__i;}
  p__37776 = new cljs.core.IndexedSeq(G__37810__a,0,null);
} 
return re_com$simple_v_table$simple_v_table_render__delegate.call(this,p__37776);};
re_com$simple_v_table$simple_v_table_render.cljs$lang$maxFixedArity = 0;
re_com$simple_v_table$simple_v_table_render.cljs$lang$applyTo = (function (arglist__37811){
var p__37776 = cljs.core.seq(arglist__37811);
return re_com$simple_v_table$simple_v_table_render__delegate(p__37776);
});
...
/** @this {Function} */
(re_com.simple_v_table.simple_v_table.cljs$lang$applyTo = (function (seq37770){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq37770));
}));
