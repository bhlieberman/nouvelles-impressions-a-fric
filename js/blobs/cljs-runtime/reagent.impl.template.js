...
var G__32450 = o;
reagent.impl.template.goog$module$goog$object.set(G__32450,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__32736__delegate = function (args){
...
while (G__32737__i < G__32737__a.length) {G__32737__a[G__32737__i] = arguments[G__32737__i + 0]; ++G__32737__i;}
  args = new cljs.core.IndexedSeq(G__32737__a,0,null);
} 
return G__32736__delegate.call(this,args);};
G__32736.cljs$lang$maxFixedArity = 0;
G__32736.cljs$lang$applyTo = (function (arglist__32738){
var args = cljs.core.seq(arglist__32738);
return G__32736__delegate(args);
});
...
var G__32468 = o;
reagent.impl.template.goog$module$goog$object.set(G__32468,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__32747__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__32748__i < G__32748__a.length) {G__32748__a[G__32748__i] = arguments[G__32748__i + 0]; ++G__32748__i;}
  args = new cljs.core.IndexedSeq(G__32748__a,0,null);
} 
return G__32747__delegate.call(this,args);};
G__32747.cljs$lang$maxFixedArity = 0;
G__32747.cljs$lang$applyTo = (function (arglist__32749){
var args = cljs.core.seq(arglist__32749);
return G__32747__delegate(args);
});
...
var G__32502 = props;
var G__32502__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__32502,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__32502);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__32502__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__32506 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__32506,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__32506;
}
})(),id_class);
...
var G__32526 = (cljs.core.count(argv) - first_child);
switch (G__32526) {
case (0):
...
var vec__32592 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32592,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32592,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32592,(2),null);
...
var temp__5808__auto___32753 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___32753 == null)){
} else {
var key_32754 = temp__5808__auto___32753;
(jsprops.key = key_32754);
}
...
var temp__5808__auto___32755 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___32755 == null)){
} else {
var key_32757 = temp__5808__auto___32755;
(jsprops.key = key_32757);
}
...
var temp__5808__auto___32763 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___32763 == null)){
} else {
var key_32765 = temp__5808__auto___32763;
(jsprops.key = key_32765);
}
...
var temp__5808__auto___32775 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___32775 == null)){
} else {
var key_32776 = temp__5808__auto___32775;
(jsprops.key = key_32776);
}
...
var temp__5808__auto___32777 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___32777 == null)){
} else {
var key_32778 = temp__5808__auto___32777;
(jsprops.key = key_32778);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32641_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__32641_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__32649 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32649,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32649,(1),null);
...
*/
reagent.impl.template.t_reagent$impl$template32711 = (function (opts,id,fn_to_element,parse_fn,meta32712){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template32711.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_32713,meta32712__$1){
var self__ = this;
var _32713__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template32711(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta32712__$1));
}));

(reagent.impl.template.t_reagent$impl$template32711.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_32713){
var self__ = this;
var _32713__$1 = this;
return self__.meta32712;
}));

(reagent.impl.template.t_reagent$impl$template32711.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template32711.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template32711.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template32711.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template32711.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template32711.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta32712","meta32712",-255668307,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template32711.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template32711.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template32711");

(reagent.impl.template.t_reagent$impl$template32711.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template32711");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template32711.
 */
reagent.impl.template.__GT_t_reagent$impl$template32711 = (function reagent$impl$template$__GT_t_reagent$impl$template32711(opts,id,fn_to_element,parse_fn,meta32712){
return (new reagent.impl.template.t_reagent$impl$template32711(opts,id,fn_to_element,parse_fn,meta32712));
});
...
return (new reagent.impl.template.t_reagent$impl$template32711(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
