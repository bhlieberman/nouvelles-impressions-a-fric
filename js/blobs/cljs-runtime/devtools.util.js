...
var i__5770__auto___28088 = (0);
while(true){
if((i__5770__auto___28088 < len__5769__auto___28087)){
args__5775__auto__.push((arguments[i__5770__auto___28088]));

var G__28089 = (i__5770__auto___28088 + (1));
i__5770__auto___28088 = G__28089;
continue;
} else {
}
break;
...
var _STAR_print_newline_STAR__orig_val__27793_28090 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__27794_28091 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__27795_28092 = true;
var _STAR_print_fn_STAR__temp_val__27796_28093 = (function (x__5691__auto__){
return sb__5690__auto__.append(x__5691__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__27795_28092);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__27796_28093);

try{var _STAR_print_level_STAR__orig_val__27798_28095 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__27799_28096 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__27799_28096);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__27798_28095);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__27794_28091);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__27793_28090);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq27788){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq27788));
}));
...
var new_formatters = current_formatters.filter((function (p1__27930_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__27930_SHARP_)));
}));
...
var G__27940_28116 = f;
var target__13500__auto___28117 = G__27940_28116;
if(cljs.core.truth_(target__13500__auto___28117)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__27940_28116)].join(''),"\n","target__13500__auto__"].join('')));
}

(target__13500__auto___28117["toString"] = (function (){
...
var G__27978_28119 = "%c%s";
var G__27979_28120 = "color:transparent";
var G__27980_28121 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__27978_28119,G__27979_28120,G__27980_28121) : f.call(null,G__27978_28119,G__27979_28120,G__27980_28121));
...
var args__5775__auto__ = [];
var len__5769__auto___28128 = arguments.length;
var i__5770__auto___28129 = (0);
while(true){
if((i__5770__auto___28129 < len__5769__auto___28128)){
args__5775__auto__.push((arguments[i__5770__auto___28129]));

var G__28130 = (i__5770__auto___28129 + (1));
i__5770__auto___28129 = G__28130;
continue;
} else {
}
break;
...
var vec__27996 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27996,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27996,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__28136__delegate = function (add_fmt,add_args){
...
var G__28136 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__28141__i = 0, G__28141__a = new Array(arguments.length -  1);
while (G__28141__i < G__28141__a.length) {G__28141__a[G__28141__i] = arguments[G__28141__i + 1]; ++G__28141__i;}
  add_args = new cljs.core.IndexedSeq(G__28141__a,0,null);
} 
return G__28136__delegate.call(this,add_fmt,add_args);};
G__28136.cljs$lang$maxFixedArity = 1;
G__28136.cljs$lang$applyTo = (function (arglist__28146){
var add_fmt = cljs.core.first(arglist__28146);
var add_args = cljs.core.rest(arglist__28146);
return G__28136__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq27990){
var G__27991 = cljs.core.first(seq27990);
var seq27990__$1 = cljs.core.next(seq27990);
var G__27992 = cljs.core.first(seq27990__$1);
var seq27990__$2 = cljs.core.next(seq27990__$1);
var G__27993 = cljs.core.first(seq27990__$2);
var seq27990__$3 = cljs.core.next(seq27990__$2);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27991,G__27992,G__27993,seq27990__$3);
}));
...
var seq__28006 = cljs.core.seq(features);
var chunk__28007 = null;
var count__28008 = (0);
var i__28009 = (0);
while(true){
if((i__28009 < count__28008)){
var feature = chunk__28007.cljs$core$IIndexed$_nth$arity$2(null,i__28009);
...
var G__28179 = seq__28006;
var G__28180 = chunk__28007;
var G__28181 = count__28008;
var G__28182 = (i__28009 + (1));
seq__28006 = G__28179;
chunk__28007 = G__28180;
count__28008 = G__28181;
i__28009 = G__28182;
continue;
} else {
var temp__5804__auto__ = cljs.core.seq(seq__28006);
if(temp__5804__auto__){
var seq__28006__$1 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__28006__$1)){
var c__5568__auto__ = cljs.core.chunk_first(seq__28006__$1);
var G__28190 = cljs.core.chunk_rest(seq__28006__$1);
var G__28191 = c__5568__auto__;
var G__28192 = cljs.core.count(c__5568__auto__);
var G__28193 = (0);
seq__28006 = G__28190;
...
var feature = cljs.core.first(seq__28006__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__28195 = cljs.core.next(seq__28006__$1);
var G__28196 = null;
var G__28197 = (0);
var G__28198 = (0);
seq__28006 = G__28195;
chunk__28007 = G__28196;
count__28008 = G__28197;
i__28009 = G__28198;
continue;
}
} else {
...
if(cljs.core.truth_(temp__5802__auto__)){
var o28039 = temp__5802__auto__;
return (o28039["version"]);
} else {
return null;
}
})() == null);
