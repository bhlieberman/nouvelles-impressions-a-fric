...
var o24257 = temp__5802__auto__;
var temp__5802__auto____$1 = (o24257["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o24258 = temp__5802__auto____$1;
return (o24258["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__13495__auto__ = f;
return (o__13495__auto__["toString"]).call(o__13495__auto__);
} else {
return "";
}
}catch (e24273){var _ = e24273;
return "";
}});
...
try{var o__13495__auto___24915 = t;
(o__13495__auto___24915["cljs$lang$ctorPrWriter"]).call(o__13495__auto___24915,t,writer);
}catch (e24292){var __24917 = e24292;
}
...
var char_code = (function (){var o__13495__auto__ = (new String(char$));
return (o__13495__auto__["charCodeAt"]).call(o__13495__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__13495__auto__ = String;
return (o__13495__auto__["fromCharCode"]).call(o__13495__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__24377 = num_code;
switch (G__24377) {
case (1):
return (185);
...
var o__13495__auto__ = String;
return (o__13495__auto__["fromCharCode"]).call(o__13495__auto__,superscript_code);
});
/**
...
}catch (e24535){var _e__13502__auto__ = e24535;
return false;
}})())){
...
var vec__24536 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24536,(0),null);
...
var len__5769__auto___24926 = arguments.length;
var i__5770__auto___24927 = (0);
while(true){
if((i__5770__auto___24927 < len__5769__auto___24926)){
args__5775__auto__.push((arguments[i__5770__auto___24927]));

var G__24928 = (i__5770__auto___24927 + (1));
i__5770__auto___24927 = G__24928;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__24621){
var vec__24623 = p__24621;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24623,(0),null);
...
var G__24930 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__24931 = cljs.core.butlast(remaining_tokens);
name_tokens = G__24930;
remaining_tokens = G__24931;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq24602){
var G__24603 = cljs.core.first(seq24602);
var seq24602__$1 = cljs.core.next(seq24602);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24603,seq24602__$1);
}));
...
var vec__24652 = cljs.core.split_with((function (p1__24648_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__24648_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24652,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24652,(1),null);
...
var vec__24658 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24658,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24658,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__24938 = cljs.core.rest(remaining_tokens);
var G__24939 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__24938;
name_tokens = G__24939;
continue;
} else {
...
var vec__24669 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24669,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24669,(1),null);
var vec__24672 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24672,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24672,(1),null);
var vec__24675 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24675,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24675,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24675,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24675,(3),null);
...
var vec__24685 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24685,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24685,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24685,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24685,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24685,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24685,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__24691 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24691,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24691,(1),null);
var vec__24695 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24695,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24695,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__24707 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__24707) : devtools.munging.parse_fn_info_deep.call(null,G__24707));
})()));
}
} else {
return fn_info;
...
var G__24956 = (arity + (1));
var G__24957 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__24748){
var vec__24753 = p__24748;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24753,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24753,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__24764_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__24764_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__24765_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__24765_SHARP_);
}),sorted_infos);
...
var args__5775__auto__ = [];
var len__5769__auto___24959 = arguments.length;
var i__5770__auto___24960 = (0);
while(true){
if((i__5770__auto___24960 < len__5769__auto___24959)){
args__5775__auto__.push((arguments[i__5770__auto___24960]));

var G__24961 = (i__5770__auto___24960 + (1));
i__5770__auto___24960 = G__24961;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__24772){
var vec__24774 = p__24772;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24774,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq24768){
var G__24769 = cljs.core.first(seq24768);
var seq24768__$1 = cljs.core.next(seq24768);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24769,seq24768__$1);
}));
...
var map__24799 = options;
var map__24799__$1 = cljs.core.__destructure_map(map__24799);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24799__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24799__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24799__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24799__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__24800 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24800,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24800,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24800,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24800,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24800,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24800,(5),null);
...
var o__13495__auto__ = f;
return (o__13495__auto__["getBasis"]).call(o__13495__auto__);
});
/**
...
}catch (e24835){var _e__13502__auto__ = e24835;
...
var G__24968 = (obj[cljs.core.first(path)]);
var G__24969 = cljs.core.rest(path);
obj = G__24968;
path = G__24969;
continue;
} else {
...
var _STAR_ = (function (accum,p__24875){
var vec__24877 = p__24875;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24877,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24877,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__24888){
var vec__24891 = p__24888;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24891,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24891,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24891,(2),null);
...
var post_process = (function (p__24906){
var vec__24907 = p__24906;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24907,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24907,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__24900_SHARP_){
return (obj[cljs.core.first(p1__24900_SHARP_)]);
}),sorted_matches);
