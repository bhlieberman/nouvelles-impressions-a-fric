...
var i_25957 = (self__.level + (1));
while(true){
if((i_25957 <= (new_level + (1)))){
(update[i_25957] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_25959 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_25959[i]));
} else {
x__$2.forward.push((((i < links_25959.length))?(links_25959[i]):null));
}

if((i < links_25959.length)){
(links_25959[i] = x__$2);
} else {
links_25959.push(x__$2);
}
...
var i_25969 = (0);
while(true){
if((i_25969 <= self__.level)){
var links_25970 = (update[i_25969]).forward;
if((x__$1 === (((i_25969 < links_25970.length))?(links_25970[i_25969]):null))){
(links_25970[i_25969] = (x__$1.forward[i_25969]));

var G__25971 = (i_25969 + (1));
i_25969 = G__25971;
continue;
} else {
var G__25972 = (i_25969 + (1));
i_25969 = G__25972;
continue;
}
} else {
