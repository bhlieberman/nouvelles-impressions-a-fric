...
var G__24975 = devtools.prefs.pref(v);
v = G__24975;
continue;
} else {
return v;
...
}catch (e24932){var _e__13502__auto__ = e24932;
return false;
}})();
...
}catch (e24935){var _e__13502__auto__ = e24935;
return false;
}})();
...
}catch (e24937){var _e__13502__auto__ = e24937;
return false;
}}
}
});
...
var vec__24953 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24953,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24953,(1),null);
...
return cljs.core.some((function (p1__24958_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__24958_SHARP_);
}),template);
});
