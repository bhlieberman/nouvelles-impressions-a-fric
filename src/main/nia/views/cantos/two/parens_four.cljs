(ns nia.views.cantos.two.parens-four
  (:require [nia.views.vutils :refer [collapsed footnote-tooltip]]
            [reagent.core :as r]
            [re-com.core :refer [h-box hyperlink p scroller v-box]]
      ...
      [[scroller
        ...
        [v-box
         ...
         [[p "Moreover, when a man, with his ear pressed stethoscopically"]
          (collapse? [p {:class :text-primary} "(((((As is done to a young person to whom the Faculty"]
          ...
          (collapse? [p {:class :text-primary} "(((((Let us not forget that indeed a voice carries"]
          ...
          [p "The "
           [footnote-tooltip {:children (r/as-element [:a "Sancy"])
                              :title "The Sancy diamond is a famous 55-carat stone of Indian origin."}]
           ";"]
          ...
          [p "The "
           [footnote-tooltip {:children (r/as-element [:a "Heidelberg Tun,"])
                              :title "A celebrated wine-cask of 1751 with a capacity of 49,000 gallons."}]
           " for a money-box;"]
          ...
          [p "- In a sculptor's studio, for a "
           [footnote-tooltip {:children (r/as-element [:a "Pouchet"])
                              :title "Pouchet. Felix-Archimede Pouchet (1800-72) was a naturalist who believed in the spontaneous generation of life from objects."}]

           " on the heath"]
          [p "Sewing his pebbles in a line, an unhurt Deucalion"]
          [p "Throwing his "
           [footnote-tooltip {:children (r/as-element [:a "stones;"])
                              :title "Deucalion Throwing his stones. In Greek myth, Deucalion built a boat in which he escaped death in the Great Flood inflicted upon
mankind by Zeus. Deucalion and his wife recreated the human race by throwing stones behind them: his stones turned into men, hers into women."}]]
          ...
          [p "Nobly takes the place of five fingers for the "
           [footnote-tooltip {:children (r/as-element [:a "penguin"])
                              :title "Nobly takes the place of five fingers for the penguin. Specifically, the manchot."}]
           ";"]
          ...
          [p "The "
           [footnote-tooltip {:children (r/as-element [:a "crow"])
                              :title "The one into which the cheese falls from/The crow. A reference to
          ...
          [p "For that which a lucky thrower gets into the mouth of a "
           [footnote-tooltip {:children (r/as-element [:a "barrel"])
                              :title "For that which a lucky thrower gets into the mouth of a barrel. A
          ...
          [p "Presents to his "
           [footnote-tooltip {:children (r/as-element [:a "master"])
                              :title "Punctuation mark > Presents to his master. i.e. !"}]
           ";"]
          ...
          [p "A "
           [footnote-tooltip {:children (r/as-element [:a "guide-ane"])
                              :title "A ruled sheet placed beneath another sheet of paper to
                                       guide the hand in straight lines when writing."}]
           ", for a stripe-fronted"]
          ...
          [p "- for a "
           [footnote-tooltip {:children (r/as-element [:a "false Bishop"])
                              :title "The Queen. In chess a Queen can move diagonally,
                                                               like a Bishop."}]
           ","]
          ...
          [p "Of string covered pouch that one uses for "
           [footnote-tooltip {:children (r/as-element [:a "spraying"])
                              :title "String-covered pouch that one uses for sraying. i.e. like a"}]
           ";"]
          ...
          [p "The flanks have described their circle, for a "
           [footnote-tooltip {:children (r/as-element [:a "torsade"])
                              :title "An ornament, usually of horsehair, consisting of filaments
                                                                 wound into a spiral."}] "."]
