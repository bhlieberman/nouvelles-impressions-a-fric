             ...
             [v-box
              ...
              [[p "Wondering thus:- if perhaps he's a thief,"]
                  ...
                  :child [scroller
                          ...
                          [v-box
                           ...
                           [[p "To give an overcoat to the new arrival in Nice"]
                            (when show?
                              [p {:class :text-danger} "(Ready as he is to swear - even on days when"])
                            (when show?
                              [p {:class :text-danger} "Snowflakes big as coins float in the biting wind -"])
                            (when show?
                              [p {:class :text-danger} "That in January one can happily go naked in Nice,"])
                            (when show?
                              [p {:class :text-danger} "Just like Archimedes shouting out a hundred times \"Eureka\")"])
               ...
               [p "More to her son than her "
                [footnote-tooltip {:children (r/as-element [:a "gossamer threads"])
                                   :title "Gossamer threads. A gratuitous pun: fils = \"son\" or \"gossamer\" threads"}] ";"]
               ...
               [p "In the street-map or the "
                [footnote-tooltip {:children (r/as-element [:a "telephone directory"])
                                   :title "Telephone directory. Another pun: bottine = \"street-map\" and Bottin was the name of the telephone directory."}] ";"]
               ...
               [p "Has yet to hold it in her arms;"]
               [p "- " [footnote-tooltip {:children (r/as-element [:a "The young author"])
                                          :title "Fame has a horror of the new."}] ","]
               ...
               [p "Could possibly be confused with a duck's;"]
               [p "- " [footnote-tooltip {:children (r/as-element [:a "The ignoramus"])
                                          :title "Ignoramuses believe that the earth is flat."}]
                " who sees a boat heading for the open sea"]
               ...
               [p  "- The bird, when "
                (when show? [:span {:class :text-primary} "(((((the sun heating even marble)))))"])]
